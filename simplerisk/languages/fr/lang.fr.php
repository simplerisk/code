...
$lang = array(
    ...
    'EmailTemplateSendingAssessment' => '
        <html><body> \\ n Bonjour, \\n <p> {$username} vous a aksed de remplir le questionnaire d\'évaluation des risques suivant:</p> \\ n <p><a href="{$assessment_link}"> {$assessment_name} </a></p> \\ n <p>This est un message automatisé et les réponses seront ignorées ou rejetées. </p> \\ n </body></html>',
    ...
    'RiskIDNoEXitFailedToUpdate' => 'Risque ID $risk_id n\'existe pas, il est donc omis de mettre à jour',
