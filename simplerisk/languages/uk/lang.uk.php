...
$lang = array(
    ...
    'Ordering' => 'Замовлення',
    'EncryptionKeyNoExist' => 'Enryption ключ файл не існує. Зверніться до адміністратора.',
    ...
    'RiskSubmitSuccess' => 'Ризик{$subject}успішно.',
    'Accepting' => 'Прийняття...',
    ...
    'WarnMySQLUploadSize' => 'Увага: розмір поточного файлу більше, ніж MySQL налаштований для додавання.  Перевірте значення max_allowed_packet та innodb_log_file_size у файлі My. ncf.',
    'Restore' => 'Відновити',
    '' => '',
);
