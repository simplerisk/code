...
$lang = array(
    ...
    'EmailTemplateSendingAssessment' => '
        <html><body>\\n Здравствуйте, \\n <p> {$username} має aksed, що ви виконати наступні ризикуєте оцінку опитувальника:</p>\\n <p><a href="{$assessment_link}"> {$assessment_name} </a></p>\\n <p>This є автоматизована повідомлення та відповіді буде проігноровано або rejected.</p>\\n </body></html>',
    ...
    'RiskIDNoEXitFailedToUpdate' => 'Ризик $risk_id ID не існує, так що це faild переконливим для оновлення',
