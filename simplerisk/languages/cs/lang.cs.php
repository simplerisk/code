...
$lang = array(
    ...
    'EmailTemplateSendingAssessment' => '
        <html><body> \\ n Hello, \\n <p> {$username} má aksed vám vyplnit následující dotazník pro posouzení rizik:</p> \\ n <p><a href="{$assessment_link}"> {$assessment_name} </a></p> \\ n <p>This je automatizovaná zpráva a odpovědi budou ignorovány nebo odmítnuty. </p> \\ n </body></html>',
    ...
    'RiskIDNoEXitFailedToUpdate' => 'ID rizika $risk_id neexistuje, takže se nedaří aktualizovat',
