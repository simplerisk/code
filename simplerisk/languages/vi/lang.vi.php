...
$lang = array(
    ...
    'Ordering' => 'Đặt hàng',
    'EncryptionKeyNoExist' => 'Enryption khóa tập tin không tồn tại. Xin vui lòng liên hệ với quản trị.',
    ...
    'RiskSubmitSuccess' => 'Nguy cơ{$subject}thành công.',
    'Accepting' => 'Chấp nhận...',
    'Rejecting' => 'Từ chối...',
    ...
    'WarnMySQLUploadSize' => 'Cảnh báo: giới hạn kích thước tệp hiện tại lớn hơn MySQL được cấu hình để tải lên.  Kiểm tra max_allowed_packet và innodb_log_file_size các giá trị trong tập tin của tôi ncf.',
    'Restore' => 'Khôi phục',
    '' => '',
);
