...
$lang = array(
    ...
    'ArtificialIntelligenceAdditionalContextDescription' => 'Следующая информация является необязательной, но предоставит искусственному интеллекту дополнительный контекст, который ему нужен для предоставления более значимых результатов. Вся информация, введенная ниже, БУДЕТ ОТПРАВЛЕНА В ANTHROPIC для анализа в их LLM, чтобы предоставить вам результаты, адаптированные для вашей организации.',
