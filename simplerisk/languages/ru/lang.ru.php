...
$lang = array(
    ...
    'UserResponsibilitiesCannotBeEditedWhenUserIsAnAdmin' => 'Обязанности пользователя нельзя редактировать, если пользователь является администратором.',
    'UserResponsibilitiesCannotBeEditedWhenUserIsGoingToBeAnAdmin' => 'Обязанности пользователя нельзя редактировать, если пользователь собирается стать администратором.',
