...
$lang = array(
    ...
    'QuestionnaireResultApprovedAuditLog' => 'Анкета "${questionnaire_name}" был одобрен пользователем "${user_name}".',
    'QuestionnaireResultRejectedAuditLog' => 'Анкета "${questionnaire_name}" был отклонен и отправлен обратно в контакт "${contact_name}" для переоценки пользователем "${user_name}" с комментарием "{$reject_comment}".',
