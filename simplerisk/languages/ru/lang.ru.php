...
$lang = array(
    ...
    'WorkflowsExtraDeactivateConfirm' => 'Деактивировать дополнительную функцию «Рабочие процессы»? Все определения рабочих процессов, включая стандартные системные, будут удалены навсегда. Повторная активация функции воссоздаст стандартные системные рабочие процессы, но все настройки будут потеряны.',
    ...
    'DataIntegrityTextEncoding' => 'Кодирование текста',
    'DataIntegrityFileEncoding' => 'Кодировка файла',
    'DataIntegrity' => 'Целостность данных',
    'DataIntegrityDesc' => 'Проверка и исправление записей с поврежденными или некорректными данными.',
    'ScanNow' => 'Сканировать сейчас',
    'BrokenValue' => 'Повреждённое значение',
    'SuggestedFix' => 'Предложенное решение',
    'RepairSelected' => 'Исправить выбранные',
    'DataIntegrityAllCaughtUpTitle' => 'Всё проверено',
    'DataIntegrityAllCaughtUpBody' => 'Проблем с целостностью данных не обнаружено.',
    'Repair' => 'Исправить',
    'DataIntegrityTotalCount' => 'итого',
    'DataIntegrityHealthCheckFailed' => '%d записи нуждаются в исправлении. Перейдите на страницу «Целостность данных» в разделе «Настройки», чтобы проверить их.',
    'DataIntegrityRecordLocation' => 'Запись:',
    'DataIntegrityNotificationTitle' => 'Обнаружены проблемы с целостностью данных.',
    'DataIntegrityNotificationBody' => 'В ходе проверки целостности данных были обнаружены записи, требующие исправления.',
    'DataIntegrityShowingCapped' => 'Отображается {n} из {total}.',
    ...
    'CouldNotLoadMappedFrameworks' => 'Не удалось загрузить сопоставленные фреймворки.',
    'NoMappedFrameworksFound' => 'Сопоставленные фреймворки не найдены.',
    'SearchMappedFrameworks' => 'Поиск фреймворков или элементов управления',
    'CommentNotAddedToAudit' => 'Ваш комментарий не удалось добавить в аудит.',
    'AssetIdsRequired' => 'НЕПРАВИЛЬНЫЙ ЗАПРОС: требуется массив asset_ids[].',
    'TheDefaultBusinessUnitCannotBeDeleted' => 'Удалить подразделение по умолчанию невозможно.',
    ...
    'OtherSessionsNotCleared' => 'Другие активные сессии не удалось закрыть, и они останутся активными до истечения срока их действия.',
    'BackupCannotResolveInstallDir' => 'Не удалось определить каталог установки SimpleRisk для резервного копирования.',
    'BackupTargetChangedOrExists' => 'Отказ в записи резервной копии в "{$dir}": целевой объект неожиданно изменился или уже существует.',
    'BackupDirectoryUnsafe' => 'Отказ в использовании резервной директории "{$location}": это символическая ссылка или она принадлежит другой учетной записи.',
    'DocumentAuditLogApprove' => 'Документ "{$document_name}" был одобрен {$user}.',
    'DocumentAuditLogUnapprove' => 'Документ "{$document_name}" был отклонен {$user}.',
    'NoApproveDocumentationPermission' => 'У вас нет разрешения на утверждение документов.',
    'DocumentApproved' => 'Документ был утвержден.',
    'DocumentUnapproved' => 'Документ не был утвержден.',
    'DocumentsApproved' => 'Документы были утверждены.',
    'ApproveSelected' => 'Одобрить выбранное',
    'SearchDocumentsPlaceholder' => 'Поиск документов',
    'NoDocumentsYet' => 'Документов пока нет.',
    'NoDocumentsYetBody' => 'Документы, добавленные в эту категорию, будут отображаться здесь.',
    'NoDocumentsMatchFilters' => 'Документы, соответствующие вашему запросу, отсутствуют.',
    'NoDocumentsMatchFiltersBody' => 'Попробуйте другой поисковый запрос или смените категорию.',
    'CouldNotLoadDocuments' => 'Не удалось загрузить документы.',
    'CouldNotLoadDocumentsBody' => 'Произошла ошибка при загрузке сетки программы для работы с документами.',
    'ApproveDocumentQuestion' => 'Утвердить этот документ?',
    'ApproveDocumentConfirmBody' => 'Это устанавливает статус "{name}" в значение "Одобрено" и рассчитывает дату следующего рассмотрения.',
    'UnapproveDocumentQuestion' => 'Отказаться от утверждения этого документа?',
    'UnapproveDocumentConfirmBody' => 'Это отправляет "{name}" обратно в раздел "На рассмотрении".',
    'ApproveSelectedDocumentsQuestion' => 'Одобрить {n} выбранные документы?',
    'ApproveSelectedDocumentsConfirmBody' => 'Эта функция утверждает {n} выбранных документов и рассчитывает дату следующего рассмотрения каждого из них.',
    'AddCategory' => 'Добавить категорию',
    'ExceptionsApproved' => 'Исключения были одобрены.',
    'FrameworkControl' => 'Структура / Управление',
    'NoExceptionsYet' => 'Пока исключений нет.',
    'NoExceptionsYetBody' => 'Добавленные вами исключения будут отображаться здесь.',
    'NoExceptionsMatchFilters' => 'Нет исключений, соответствующих вашему запросу.',
    'NoExceptionsMatchFiltersBody' => 'Попробуйте другой поисковый запрос или очистите область поиска.',
    'CouldNotLoadExceptions' => 'Не удалось загрузить исключения.',
    'CouldNotLoadExceptionsBody' => 'Произошла ошибка при загрузке сетки «Определение исключений».',
    'ApproveExceptionQuestion' => 'Одобрить это исключение?',
    'ApproveExceptionConfirmBody' => 'Это устанавливает значение "{name}" в значение «Одобрено».',
    'UnapproveExceptionQuestion' => 'Отклонить это исключение?',
    'UnapproveExceptionConfirmBody' => 'Это отправляет "{name}" обратно в состояние "Ожидание".',
    'ApproveSelectedExceptionsQuestion' => 'Одобрить {n} выбранные исключения?',
    'ApproveSelectedExceptionsConfirmBody' => 'Это подтверждает {n} выбранные исключения.',
    'SearchExceptionsPlaceholder' => 'Исключения при поиске...',
    'DeleteSelected' => 'Удалить выбранное',
    'ExceptionsDeleted' => 'Выбранные исключения были удалены.',
    'GovernanceReviewDueEmailSubject' => 'Срок сдачи рецензии: {$name}',
    'GovernanceReviewDueEmailBody' => '{$name} подлежит проверке.',
    'DocumentDetails' => 'Подробности документа',
    'WhereItApplies' => 'Там, где это применимо',
    'WhoIsInvolved' => "Кто участвует?",
    'ReviewCadence' => 'периодичность обзора',
    'ExceptionDetails' => 'Подробности исключения',
    'DescriptionJustification' => 'Описание и обоснование',
    'ChooseAControl' => 'Выберите элемент управления',
    'CantDeleteDocumentCategoryInUse' => 'Удалить этот тип документа невозможно, поскольку в настоящее время уже есть документы, относящиеся к этому типу.',
    'ExceptionDoesNotExist' => 'Исключение для документа отсутствует.',
    'DocumentAuditTrailReport' => 'Отчет о следе проверки документов',
    'PastWeek' => 'Прошедшая неделя',
    'PastMonth' => 'Прошлый месяц',
    'PastQuarter' => 'Прошедший квартал',
    'Past6Months' => 'Последние 6 месяцев',
    'PastYear' => 'Прошлый год',
    'CantRenameSeededDocumentCategory' => 'Встроенные типы документов нельзя переименовать, поскольку другие компоненты SimpleRisk ссылаются на них по их исходным именам. Вы можете добавлять свои собственные типы и свободно переименовывать их.',
    'DocumentsApprovedTruncated' => 'Были одобрены только первые {$limit} выбранных документов. Пожалуйста, повторите действие, чтобы одобрить остальные.',
    'ExceptionsApprovedTruncated' => 'Были одобрены только первые {$limit} выбранных исключений. Пожалуйста, повторите действие, чтобы одобрить остальные.',
    'AreYouSureYouWantToDeleteTheseDocuments' => 'Вы уверены, что хотите удалить эти документы?',
    'DocumentsDeleted' => 'Выбранные документы были удалены.',
    'AllApprovers' => 'Все утверждающие',
    'NotScheduled' => 'Не запланировано',
    'LastReviewDate' => 'Дата последнего пересмотра',
    'DocumentAuditLogDownload' => 'Документ "{$document_name}" был загружен пользователем {$user}.',
    'Refresh' => 'Обновить',
    'AuditTrailDateAndTime' => 'Дата и время',
    'Activity' => 'Активность',
    'Updated' => 'Обновлено',
    'Deleted' => 'Удалено',
    ...
    'SearchAuditTrailPlaceholder' => 'Поиск в журнале аудита',
    'NoAuditLogEntries' => 'Записей в журнале аудита пока нет.',
    'NoAuditLogEntriesBody' => 'Здесь будет отображаться информация об активности в документах на этой странице.',
    'NoAuditLogEntriesMatchFilters' => 'Записей, соответствующих вашему запросу, нет.',
    'NoAuditLogEntriesMatchFiltersBody' => 'Попробуйте другой поисковый запрос, диапазон дат или фильтр.',
    'By' => 'к',
    'UnknownUser' => 'Неизвестный пользователь',
    'AllActivities' => 'Все виды деятельности',
    'DownloadSelected' => 'Загрузить выбранные',
    'NoDocumentsSelectedForDownload' => 'Для скачивания не было выбрано ни одного документа.',
    'DocumentsDownloadTruncated' => 'В загрузку включены только первые {$limit} выбранных документов. Пожалуйста, повторите действие, чтобы загрузить остальные.',
    'NoDownloadableDocumentsSelected' => 'Ни один из выбранных документов не имеет файла для скачивания.',
    'VersionHistory' => 'История версий',
    'Current' => 'Текущий',
    'DeleteVersion' => 'Удалить эту версию',
    'ConfirmDeleteVersionQuestion' => 'Удалить эту версию файла?',
    'ConfirmDeleteVersionConfirmBody' => 'Это удалит только данную историческую версию файла. Документ и его текущий файл останутся без изменений.',
    'CannotDeleteCurrentDocumentVersion' => 'Текущую версию документа нельзя удалить таким способом. Вместо этого используйте действие «Удалить» непосредственно для самого документа.',
    'DocumentVersionDeleted' => 'Версия документа была удалена.',
    'DeletedVersion' => 'Версия удалена',
    'CouldNotLoadVersionHistory' => 'Не удалось загрузить историю версий.',
    'DocumentsOverdueForReview' => 'Документы, просроченные для проверки.',
    'DocumentsDueSoonForReview' => 'Документы должны быть представлены на рассмотрение в ближайшее время.',
    'RequiresCustomizationExtra' => 'Требуется дополнительная опция "Настройка".',
    'UnlockCustomizationLink' => 'Посмотрите, что это добавит.',
    'UnlockActivateCustomizationNote' => 'Дополнительная опция "Настройка" установлена, но не активирована.',
    'UnlockActivateCustomizationLink' => 'Включите его',
    'ExceptionsOverdueForReview' => 'Исключения, подлежащие рассмотрению',
    'ExceptionsDueSoonForReview' => 'Исключения будут рассмотрены в ближайшее время.',
    'PendingApproval' => 'Ожидается утверждение.',
    'AllExceptions' => 'Все исключения',
    'AllStates' => 'Все штаты',
    'DocumentDoesNotExist' => 'Документ не существует',
    'SomeExceptionsNotDeleted' => 'Некоторые из выбранных исключений удалить не удалось. Пожалуйста, обновите страницу и попробуйте снова.',
    'SomeDocumentsNotDeleted' => 'Некоторые из выбранных документов удалить не удалось. Пожалуйста, обновите страницу и попробуйте снова.',
    // Scheduled report "Run Now" success alerts (process_run_now_notification())
    'AutomatedNotificationOfRisksSent' => 'Автоматическое уведомление о непроверенных и просроченных рисках отправлено.',
    'AutomatedNotificationOfAuditsSent' => 'Автоматическое уведомление о проверках отправлено.',
    'AutomatedNotificationOfMitigationsSent' => 'Автоматическое уведомление о принятых мерах отправлено.',
    'AutomatedNotificationOfUnmitigatedRisksSent' => 'Автоматическое уведомление о неустраненных рисках отправлено.',
    'AutomatedNotificationOfPolicyControlExceptionsSent' => 'Автоматическое уведомление о непроверенных и просроченных исключениях из правил и процедур контроля отправлено.',
    'AutomatedNotificationOfDocumentReviewsSent' => 'Автоматическое уведомление о проверке документов отправлено.',
    'NoWorkflowsDefinedYet' => 'Пока не определены никакие рабочие процессы. Нажмите «Новый рабочий процесс», чтобы создать его.',
    'NoPermissionToViewDocumentation' => 'У вас нет разрешения на просмотр документации.',
    'AddDocumentType' => 'Добавить тип документа',
    'BuiltIn' => 'Встроенный',
    'TemplateGroups' => 'Группы шаблонов',
    'ManageDocumentTypes' => 'Управление типами документов',
    'NeedANewCategoryManageDocumentTypes' => 'Нужна новая категория?',
    'ManageOptions' => 'Управление параметрами',
    'AddCustomFieldSubtitle' => 'Добавьте пользовательские поля для сбора информации, специфичной для этой группы полей.',
    'NewField' => 'Новое поле',
    'TemplateGroupsSectionSubtitle' => 'Создайте дополнительные группы шаблонов и назначьте их бизнес-подразделениям.',
    'TemplateSectionSubtitle' => 'Выберите, какие поля будут отображаться в этом шаблоне и в каком порядке.',
    'CustomFieldsSectionSubtitle' => 'Все пользовательские поля, определенные для этой группы полей, во всех шаблонах.',
    'CantDeleteSeededDocumentCategory' => 'Встроенные типы документов удалить нельзя, поскольку другие компоненты SimpleRisk ссылаются на них по их исходным именам. Вы можете добавлять и удалять собственные типы по своему усмотрению.',
    'FieldGroupSelectorSubtitle' => 'Выберите поля и шаблоны какой группы полей вы хотите настроить.',
    'CloneTemplateGroup' => 'Клонируйте эту группу шаблонов',
    'RequiredFieldCheckboxLabel' => 'Сделайте это пользовательское поле обязательным.',
    'AddField' => 'Добавить поле',
    'CoreFields' => 'Основные области',
    'SearchCoreFields' => 'Поиск основных полей',
    'SearchCustomFields' => 'Поиск по пользовательским полям',
    'AllCoreFieldsAddedToTab' => 'Все основные поля находятся на этой вкладке.',
    'AllCustomFieldsAddedToTemplate' => 'Все пользовательские поля находятся в этом шаблоне.',
    'NoFieldsMatchSearchTerm' => 'Ни одно поле не соответствует "{term}".',
    'NoCustomFieldsYet' => 'На данный момент нет пользовательских полей — создайте одно из них ниже, чтобы использовать его в этом шаблоне.',
    'AddFieldsToPrefix' => 'Добавить поля в',
    'AddFieldsHeading' => 'Добавить поля',
    'FieldPickerHint' => 'При нажатии на поле оно сразу добавляется в макет ниже. Подтверждать ничего не нужно.',
    'Done' => 'Сделанный',
    'FieldAddedToTab' => 'Добавлено {field} к {tab}.',
    'FieldRemovedBackToList' => 'Удалено {field} — оно снова в списке.',
    'NowAddingToTab' => 'Теперь добавляем к {tab}.',
    'PickFieldToAdd' => 'Выберите поле из любого столбца, чтобы добавить его.',
