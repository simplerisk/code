...
$lang = array(
    ...
    'Ordering' => 'Заказа',
    'EncryptionKeyNoExist' => 'Енриптион ключевой файл не существует. Пожалуйста, свяжитесь с администратором.',
    ...
    'WarnMySQLUploadSize' => 'Предупреждение: текущий размер файла больше, чем MySQL настроен для загрузки.  Проверьте значения макс_алловед_паккет и иннодб_лог_филе_сизе в файле my..',
