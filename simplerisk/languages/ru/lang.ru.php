...
$lang = array(
    ...
    'EmailTemplateSendingAssessment' => '
        <html><body> \\ n Hello, \\n <p> {$username} aksed вам заполнить следующую анкету по оценке рисков:</p> \\ n <p><a href="{$assessment_link}"> {$assessment_name} </a></p> \\ n <p>сис является автоматизированным сообщение и ответы будут игнорироваться или отклонены. </p> \\ n </body></html>',
    ...
    'RiskIDNoEXitFailedToUpdate' => 'Код риска $risk_id не существует, поэтому он не обновляется',
