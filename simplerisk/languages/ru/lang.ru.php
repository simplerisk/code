...
$lang = array(
    ...
    'ActivatingSCFMessage' => 'Установка инфраструктуры Secure Controls Framework (SCF). Это может занять несколько минут.',
    'DeactivatingSCFMessage' => 'Удаление инфраструктуры Secure Controls Framework (SCF).',
    'UpdatingSCFMessage' => 'Обновление инфраструктуры Secure Controls Framework (SCF). Это может занять несколько минут.',
    ...
    'EnableAIAssistanceForRiskData' => 'Включить поддержку ИИ для данных о рисках (данные будут отправлены в Anthropic с использованием вашего ключа API)',
    ...
    'EnableAIAssistanceForDocumentData' => 'Включить поддержку ИИ для данных документа (данные будут отправлены в Anthropic с использованием вашего ключа API)',
