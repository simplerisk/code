...
$lang = array(
    ...
    'EnablingSelectedSCFMessage' => 'Включение выбранных платформ Secure Controls Framework (SCF). Это может занять несколько секунд.',
    'DisablingSelectedSCFMessage' => 'Отключение выбранных платформ Secure Controls Framework (SCF).',
