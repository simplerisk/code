...
$lang = array(
    ...
    'SubQuestions' => '子問題',
    'Ordering' => '訂購',
    'EncryptionKeyNoExist' => 'Enryption 金鑰檔不存在。請與管理員聯繫。',
    ...
    'RiskSubmitSuccess' => '風險{$subject}成功.',
    'Accepting' => '接受。。。',
    'Rejecting' => '拒絕。。。',
    ...
    'WarnMySQLUploadSize' => '警告: 當前檔案大小限制大於為上載配置的 MySQL。 檢查我的. ncf 檔中的 max_allowed_packet 和 innodb_log_file_size 值。',
    'Restore' => '恢復',
    '' => '',
);
