...
$lang = array(
    ...
    'EmailTemplateSendingAssessment' => '
        <html><body> \\ n Hola, \\n <p> {$username} ha pidió que complete el siguiente cuestionario de evaluación del riesgo:</p> \\ n <p><a href="{$assessment_link}"> {$assessment_name} </a></p> \\ n <p>This es un mensaje automatizado y las respuestas serán ignoradas o rechazadas. </p> \\ n </body></html>',
    ...
    'RiskIDNoEXitFailedToUpdate' => 'El ID de riesgo $risk_id no existe, por lo que no se actualiza',
