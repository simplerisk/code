...
$lang = array(
    ...
    'EmailTemplateSendingAssessment' => '
        <html><body> \\ n Hej, \\n <p> {$username} har aksed dig att slutföra följande riskbedömning frågeformulär:</p> \\ n <p><a href="{$assessment_link}"> {$assessment_name} </a></p> \\ n <p>This är ett automatiskt meddelande och svar kommer att ignoreras eller avvisas. </p> \\ n </body></html>',
    ...
    'RiskIDNoEXitFailedToUpdate' => 'Risk-ID- $risk_id finns inte, så det går inte att uppdatera',
