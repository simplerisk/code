...
$lang = array(
    ...
    'EmailTemplateSendingAssessment' => '
        <html><body> \\ n Hello, \\n <p> {$username} har aksed deg å fullføre følgende risikovurdering spørreskjema:</p> \\ n <p><a href="{$assessment_link}"> {$assessment_name} </a></p> \\ n <p>This er en automatisert melding og svar vil bli ignorert eller forkastet. </p> \\ n </body></html>',
    ...
    'RiskIDNoEXitFailedToUpdate' => 'Risiko-ID $risk_id finnes ikke, så det kan ikke oppdateres',
