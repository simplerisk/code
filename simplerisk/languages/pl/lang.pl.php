...
$lang = array(
    ...
    'EmailTemplateSendingAssessment' => '
        <html><body> \\ n Hello, \\n <p> {$username} ma aksed do wykonania następującego kwestionariusza oceny ryzyka:</p> \\ n <p><a href="{$assessment_link}"> {$assessment_name} </a></p> \\ n <p>This jest automatyczną wiadomością, a odpowiedzi zostaną zignorowane lub odrzucone. </p> \\ n </body></html>',
    ...
    'RiskIDNoEXitFailedToUpdate' => 'Identyfikator ryzyka $risk_id nie istnieje, więc nie jest aktualizacja',
