...
$lang = array(
    ...
    'WorkflowsExtraDeactivateConfirm' => 'هل تريد تعطيل ميزة "سير العمل الإضافي"؟ سيتم حذف جميع تعريفات سير العمل، بما في ذلك سير العمل الافتراضي للنظام، نهائيًا. سيؤدي إعادة تفعيل الميزة الإضافية إلى إعادة إنشاء سير العمل الافتراضي للنظام، ولكن ستُفقد أي تخصيصات أُجريت عليه.',
    ...
    'DataIntegrityTextEncoding' => 'ترميز النص',
    'DataIntegrityFileEncoding' => 'ترميز الملف',
    'DataIntegrity' => 'سلامة البيانات',
    'DataIntegrityDesc' => 'مراجعة وإصلاح السجلات التي تحتوي على بيانات تالفة أو غير صالحة.',
    'ScanNow' => 'فحص الآن',
    'BrokenValue' => 'قيمة تالفة',
    'SuggestedFix' => 'الحل المقترح',
    'RepairSelected' => 'إصلاح المحدد',
    'DataIntegrityAllCaughtUpTitle' => 'تم الانتهاء من كل شيء',
    'DataIntegrityAllCaughtUpBody' => 'لم يتم العثور على أي مشاكل تتعلق بسلامة البيانات.',
    'Repair' => 'إصلاح',
    'DataIntegrityTotalCount' => 'المجموع',
    'DataIntegrityHealthCheckFailed' => '%d سجل/سجلات تحتاج إلى إصلاح. قم بزيارة صفحة سلامة البيانات ضمن الإعدادات لمراجعتها.',
    'DataIntegrityRecordLocation' => 'سِجِلّ:',
    'DataIntegrityNotificationTitle' => 'تم اكتشاف مشكلات في سلامة البيانات',
    'DataIntegrityNotificationBody' => 'كشف فحص سلامة البيانات عن وجود سجلات تحتاج إلى إصلاح.',
    'DataIntegrityShowingCapped' => 'عرض {n} من {total}.',
    ...
    'CouldNotLoadMappedFrameworks' => 'تعذر تحميل الأطر المُرتبطة.',
    'NoMappedFrameworksFound' => 'لم يتم العثور على أي أطر عمل مرتبطة.',
    'SearchMappedFrameworks' => 'ابحث عن الأطر أو عناصر التحكم',
    'CommentNotAddedToAudit' => 'لم يتم إضافة تعليقك إلى عملية التدقيق.',
    'AssetIdsRequired' => 'طلب غير صالح: asset_ids[] مطلوب.',
    'TheDefaultBusinessUnitCannotBeDeleted' => 'لا يمكن حذف وحدة الأعمال الافتراضية.',
    ...
    'OtherSessionsNotCleared' => 'لم يتم مسح الجلسات النشطة الأخرى وستبقى مسجلة الدخول حتى تنتهي صلاحيتها.',
    'BackupCannotResolveInstallDir' => 'تعذر تحديد مسار تثبيت برنامج SimpleRisk الخاص بالنسخ الاحتياطي.',
    'BackupTargetChangedOrExists' => 'رفض كتابة النسخة الاحتياطية في "{$dir}": لقد تغير الهدف بشكل غير متوقع أو موجود بالفعل.',
    'BackupDirectoryUnsafe' => 'رفض استخدام دليل النسخ الاحتياطي "{$location}": إنه رابط رمزي أو مملوك لحساب آخر.',
    'DocumentAuditLogApprove' => 'تمت الموافقة على المستند "{$document_name}" بواسطة {$user}.',
    'DocumentAuditLogUnapprove' => 'تم إلغاء الموافقة على المستند "{$document_name}" بواسطة {$user}.',
    'NoApproveDocumentationPermission' => 'ليس لديك إذن بالموافقة على المستندات.',
    'DocumentApproved' => 'تمت الموافقة على الوثيقة.',
    'DocumentUnapproved' => 'تم إلغاء الموافقة على الوثيقة.',
    'DocumentsApproved' => 'تمت الموافقة على الوثائق.',
    'ApproveSelected' => 'الموافقة على الاختيار',
    'SearchDocumentsPlaceholder' => 'البحث في المستندات',
    'NoDocumentsYet' => 'لا توجد مستندات بعد',
    'NoDocumentsYetBody' => 'ستظهر المستندات المضافة إلى هذه الفئة هنا.',
    'NoDocumentsMatchFilters' => 'لا توجد مستندات تطابق بحثك',
    'NoDocumentsMatchFiltersBody' => 'جرب مصطلح بحث مختلف أو غيّر الفئات.',
    'CouldNotLoadDocuments' => 'تعذر تحميل المستندات',
    'CouldNotLoadDocumentsBody' => 'حدث خطأ ما أثناء تحميل شبكة برنامج المستندات.',
    'ApproveDocumentQuestion' => 'هل توافق على هذه الوثيقة؟',
    'ApproveDocumentConfirmBody' => 'هذا يضبط "{name}" على "موافق عليه" ويحسب تاريخ المراجعة التالي.',
    'UnapproveDocumentQuestion' => 'هل تريد إلغاء الموافقة على هذا المستند؟',
    'UnapproveDocumentConfirmBody' => 'هذا يُعيد "{name}" إلى قسم "قيد المراجعة".',
    'ApproveSelectedDocumentsQuestion' => 'الموافقة على {n} من المستندات المحددة؟',
    'ApproveSelectedDocumentsConfirmBody' => 'هذا يوافق على {n} المستندات المحددة ويحسب تاريخ المراجعة التالي لكل منها.',
    'AddCategory' => 'إضافة فئة',
    'ExceptionsApproved' => 'تمت الموافقة على الاستثناءات.',
    'FrameworkControl' => 'الإطار / الضابط',
    'NoExceptionsYet' => 'لا استثناءات حتى الآن',
    'NoExceptionsYetBody' => 'ستظهر الاستثناءات التي تضيفها هنا.',
    'NoExceptionsMatchFilters' => 'لم يتم العثور على أي استثناءات تطابق بحثك',
    'NoExceptionsMatchFiltersBody' => 'جرب مصطلح بحث مختلف أو امسح نتائج البحث.',
    'CouldNotLoadExceptions' => 'تعذر تحميل الاستثناءات',
    'CouldNotLoadExceptionsBody' => 'حدث خطأ ما أثناء تحميل شبكة تعريف الاستثناءات.',
    'ApproveExceptionQuestion' => 'هل توافق على هذا الاستثناء؟',
    'ApproveExceptionConfirmBody' => 'هذا يضبط "{name}" على "موافق عليه".',
    'UnapproveExceptionQuestion' => 'هل تريد إلغاء الموافقة على هذا الاستثناء؟',
    'UnapproveExceptionConfirmBody' => 'هذا يُعيد "{name}" إلى حالة "معلق".',
    'ApproveSelectedExceptionsQuestion' => 'الموافقة على الاستثناءات المحددة {n}؟',
    'ApproveSelectedExceptionsConfirmBody' => 'هذا يوافق على الاستثناءات المحددة {n}.',
    'SearchExceptionsPlaceholder' => 'البحث في الاستثناءات...',
    'DeleteSelected' => 'حذف المحدد',
    'ExceptionsDeleted' => 'تم حذف الاستثناءات المحددة.',
    'GovernanceReviewDueEmailSubject' => 'مراجعة مستحقة: {$name}',
    'GovernanceReviewDueEmailBody' => '{$name} بحاجة إلى مراجعة.',
    'DocumentDetails' => 'تفاصيل المستند',
    'WhereItApplies' => 'حيثما ينطبق ذلك',
    'WhoIsInvolved' => "من هم المشاركون",
    'ReviewCadence' => 'وتيرة المراجعة',
    'ExceptionDetails' => 'تفاصيل الاستثناء',
    'DescriptionJustification' => 'الوصف والتبرير',
    'ChooseAControl' => 'اختر عنصر تحكم',
    'CantDeleteDocumentCategoryInUse' => 'لا يمكن حذف هذا النوع من المستندات، لأنه توجد مستندات مصنفة حاليًا تحته.',
    'ExceptionDoesNotExist' => 'استثناء المستند غير موجود',
    'DocumentAuditTrailReport' => 'تقرير سجل تدقيق المستندات',
    'PastWeek' => 'الأسبوع الماضي',
    'PastMonth' => 'الشهر الماضي',
    'PastQuarter' => 'الربع الماضي',
    'Past6Months' => 'الأشهر الستة الماضية',
    'PastYear' => 'العام الماضي',
    'CantRenameSeededDocumentCategory' => 'لا يمكن إعادة تسمية أنواع المستندات المدمجة، لأن أجزاء أخرى من SimpleRisk تشير إليها بأسمائها الأصلية. يمكنك إضافة أنواعك الخاصة وإعادة تسميتها بحرية.',
    'DocumentsApprovedTruncated' => 'تمت الموافقة على أول {$limit} مستندات فقط. يرجى تكرار العملية للموافقة على باقي المستندات.',
    'ExceptionsApprovedTruncated' => 'تمت الموافقة على الاستثناءات المحددة الأولى فقط {$limit} . يرجى تكرار العملية للموافقة على الباقي.',
    'AreYouSureYouWantToDeleteTheseDocuments' => 'هل أنت متأكد من رغبتك في حذف هذه المستندات؟',
    'DocumentsDeleted' => 'تم حذف المستندات المحددة.',
    'AllApprovers' => 'جميع الموافقين',
    'NotScheduled' => 'غير مُجدول',
    'LastReviewDate' => 'تاريخ آخر مراجعة',
    'DocumentAuditLogDownload' => 'تم تنزيل المستند "{$document_name}" بواسطة {$user}.',
    'Refresh' => 'تحديث',
    'AuditTrailDateAndTime' => 'التاريخ والوقت',
    'Activity' => 'نشاط',
    'Updated' => 'تم التحديث',
    'Deleted' => 'تم الحذف',
    ...
    'SearchAuditTrailPlaceholder' => 'ابحث في سجل التدقيق',
    'NoAuditLogEntries' => 'لا توجد إدخالات في سجل التدقيق حتى الآن',
    'NoAuditLogEntriesBody' => 'ستظهر هنا جميع الأنشطة المتعلقة بمستندات هذه الصفحة.',
    'NoAuditLogEntriesMatchFilters' => 'لا توجد نتائج مطابقة لبحثك',
    'NoAuditLogEntriesMatchFiltersBody' => 'جرب مصطلح بحث مختلف، أو نطاق تاريخ مختلف، أو فلتر مختلف.',
    'By' => 'بواسطة',
    'UnknownUser' => 'مستخدم غير معروف',
    'AllActivities' => 'جميع الأنشطة',
    'DownloadSelected' => 'تنزيل المحدد',
    'NoDocumentsSelectedForDownload' => 'لم يتم اختيار أي مستندات للتنزيل.',
    'DocumentsDownloadTruncated' => 'تم تضمين أول {$limit} مستندات محددة فقط في التنزيل. يرجى تكرار العملية لتنزيل الباقي.',
    'NoDownloadableDocumentsSelected' => 'لا يوجد ملف قابل للتنزيل لأي من المستندات المختارة.',
    'VersionHistory' => 'سجل الإصدارات',
    'Current' => 'الحالي',
    'DeleteVersion' => 'احذف هذه النسخة',
    'ConfirmDeleteVersionQuestion' => 'هل تريد حذف نسخة هذا الملف؟',
    'ConfirmDeleteVersionConfirmBody' => 'يؤدي هذا الإجراء إلى حذف نسخة الملف القديمة فقط. ولا يتأثر المستند أو ملفه الحالي.',
    'CannotDeleteCurrentDocumentVersion' => 'لا يمكن حذف النسخة الحالية من المستند بهذه الطريقة. استخدم إجراء الحذف على المستند نفسه بدلاً من ذلك.',
    'DocumentVersionDeleted' => 'تم حذف نسخة المستند.',
    'DeletedVersion' => 'تم حذف النسخة',
    'CouldNotLoadVersionHistory' => 'تعذر تحميل سجل الإصدارات.',
    'DocumentsOverdueForReview' => 'مستندات متأخرة عن المراجعة',
    'DocumentsDueSoonForReview' => 'المستندات المستحقة للمراجعة قريباً',
    'RequiresCustomizationExtra' => 'يتطلب ذلك خيار التخصيص الإضافي.',
    'UnlockCustomizationLink' => 'انظر ماذا يضيف ذلك',
    'UnlockActivateCustomizationNote' => 'تم تثبيت إضافة التخصيص ولكن لم يتم تشغيلها.',
    'UnlockActivateCustomizationLink' => 'قم بتشغيله',
    'ExceptionsOverdueForReview' => 'الاستثناءات التي تأخرت مراجعتها',
    'ExceptionsDueSoonForReview' => 'الاستثناءات المستحقة للمراجعة قريباً',
    'PendingApproval' => 'بانتظار الموافقة',
    'AllExceptions' => 'جميع الاستثناءات',
    'AllStates' => 'جميع الحالات',
    'DocumentDoesNotExist' => 'المستند غير موجود',
    'SomeExceptionsNotDeleted' => 'تعذر حذف بعض الاستثناءات المحددة. يرجى تحديث الصفحة والمحاولة مرة أخرى.',
    'SomeDocumentsNotDeleted' => 'تعذر حذف بعض المستندات المحددة. يرجى تحديث الصفحة والمحاولة مرة أخرى.',
    // Scheduled report "Run Now" success alerts (process_run_now_notification())
    'AutomatedNotificationOfRisksSent' => 'تم إرسال الإشعار الآلي بالمخاطر غير المراجعة والمتأخرة.',
    'AutomatedNotificationOfAuditsSent' => 'تم إرسال الإشعار الآلي الخاص بعمليات التدقيق.',
    'AutomatedNotificationOfMitigationsSent' => 'تم إرسال الإشعار الآلي بشأن إجراءات التخفيف.',
    'AutomatedNotificationOfUnmitigatedRisksSent' => 'تم إرسال الإشعار الآلي بالمخاطر التي لم يتم تخفيفها.',
    'AutomatedNotificationOfPolicyControlExceptionsSent' => 'تم إرسال الإشعار الآلي بشأن استثناءات السياسة والضوابط التي لم تتم مراجعتها والمتأخرة عن موعد استحقاقها.',
    'AutomatedNotificationOfDocumentReviewsSent' => 'تم إرسال الإشعار الآلي بمراجعات المستندات.',
    'NoWorkflowsDefinedYet' => 'لم يتم تحديد أي مسارات عمل بعد. انقر فوق "مسار عمل جديد" لإنشاء واحد.',
    'NoPermissionToViewDocumentation' => 'ليس لديك إذن لعرض الوثائق',
    'AddDocumentType' => 'إضافة نوع المستند',
    'BuiltIn' => 'مدمج',
    'TemplateGroups' => 'مجموعات القوالب',
    'ManageDocumentTypes' => 'إدارة أنواع المستندات',
    'NeedANewCategoryManageDocumentTypes' => 'هل تحتاج إلى فئة جديدة؟',
    'ManageOptions' => 'إدارة الخيارات',
    'AddCustomFieldSubtitle' => 'أضف حقولاً مخصصة لالتقاط معلومات خاصة بمجموعة الحقول هذه.',
    'NewField' => 'حقل جديد',
    'TemplateGroupsSectionSubtitle' => 'أنشئ مجموعات قوالب إضافية وقم بتعيينها لوحدات الأعمال.',
    'TemplateSectionSubtitle' => 'اختر الحقول التي ستظهر في هذا القالب، وبأي ترتيب.',
    'CustomFieldsSectionSubtitle' => 'جميع الحقول المخصصة المحددة لمجموعة الحقول هذه، عبر كل قالب.',
    'CantDeleteSeededDocumentCategory' => 'لا يمكن حذف أنواع المستندات المدمجة، لأن أجزاء أخرى من SimpleRisk تشير إليها بأسمائها الأصلية. يمكنك إضافة أنواعك الخاصة وحذف الأنواع الموجودة بحرية.',
    'FieldGroupSelectorSubtitle' => 'اختر الحقول والقوالب التي تريد تخصيصها ضمن مجموعة الحقول.',
    'CloneTemplateGroup' => 'استنسخ مجموعة القوالب هذه',
    'RequiredFieldCheckboxLabel' => 'اجعل هذا الحقل المخصص إلزاميًا.',
    'AddField' => 'إضافة حقل',
    'CoreFields' => 'الحقول الأساسية',
    'SearchCoreFields' => 'البحث في الحقول الأساسية',
    'SearchCustomFields' => 'البحث في الحقول المخصصة',
    'AllCoreFieldsAddedToTab' => 'جميع الحقول الأساسية موجودة في علامة التبويب هذه.',
    'AllCustomFieldsAddedToTemplate' => 'جميع الحقول المخصصة موجودة في هذا القالب.',
    'NoFieldsMatchSearchTerm' => 'لا توجد حقول مطابقة لـ "{term}".',
    'NoCustomFieldsYet' => 'لا توجد حقول مخصصة حتى الآن - أنشئ حقلاً أدناه لاستخدامه في هذا القالب.',
    'AddFieldsToPrefix' => 'أضف الحقول إلى',
    'AddFieldsHeading' => 'إضافة حقول',
    'FieldPickerHint' => 'يؤدي النقر على حقل إلى إضافته مباشرةً إلى التخطيط أدناه. لا حاجة للتأكيد.',
    'Done' => 'تم',
    'FieldAddedToTab' => 'تمت إضافة {field} إلى {tab}.',
    'FieldRemovedBackToList' => 'تمت إزالة العنصر {field} -- لقد عاد إلى قائمته.',
    'NowAddingToTab' => 'إضافة الآن إلى {tab}.',
    'PickFieldToAdd' => 'اختر حقلاً من أي من العمودين لإضافته.',
