...
$lang = array(
    ...
    'Import'=>'Importação',
    'Export'=>'Exportação',
    'ActivateTheImportExportExtra'=>'Ative o Importação / Exportação extra',
    ...
    'AutomatedDiscovery'=>'Automated Descoberta',
    'BatchImport'=>'Batch Import',
    'ManageAssets'=>'Gerenciar Ativos',
    'AssetValuation'=>'Avaliação Patrimonial',
    'AllowAccessToAssetManagementMenu'=>'Permitir acesso ao Menu "Asset Management"',
    'AutomatedDiscoveryHelp'=>'Descubra todos os endereços IP ao vivo na faixa de IP digitado. Endereços IP ao vivo será adicionado à lista de ativos. Formatos aceitáveis:',
    'IPRange'=>'IP Range',
    'Search'=>'Pesquisa',
    ...
    'AssetWasAddedSuccessfully'=>'Ativos foi adicionada com êxito.',
    'AssetWasDeletedSuccessfully'=>'Ativos foi excluído com sucesso.',
    ...
    'ComingSoon'=>'Em Breve',
    'ExportRisks'=>'Riscos de Exportação',
    'ExportMitigations'=>'Exportação Mitigations',
    'ExportReviews'=>'Exportação Avaliações',
    'ExportCombined'=>'Exportação Combinada',
    'MitigatedBy'=>'Mitigado Por',
    'MitigationId'=>'Mitigação ID',
    ...
    'RisksDeletedSuccessfully'=>'Riscos Excluído Com Sucesso',
