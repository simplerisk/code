...
$lang = array(
    ...
    'CustomExtrasText'=>'Seria fantástico se tudo fosse livre, certo? Esperemos que a plataforma central SimpleRisk é capaz de servir todas as suas necessidades de gestão de risco. Mas, se você se encontrar ainda querendo mais funcionalidade, temos desenvolvido uma série de "Extras" que vai fazer exatamente isso por apenas algumas centenas de dólares cada para uma licença perpétua.',
    'Upgrade'=>'Atualização',
    'Install'=>'Instalar',
    'Purchase'=>'Compra',
