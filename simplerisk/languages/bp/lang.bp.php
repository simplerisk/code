...
$lang = array(
    ...
    'EmailTemplateSendingAssessment' => '
        <html><body> \\ n Olá, \\n <p> {$username} tem Aksed para concluir o seguinte questionário de avaliação de risco:</p> \\ n <p><a href="{$assessment_link}"> {$assessment_name} </a></p> \\ n <p>This é uma mensagem automatizada e as respostas serão ignoradas ou rejeitadas. </p> \\ n </body></html>',
    ...
    'RiskIDNoEXitFailedToUpdate' => 'ID de risco $risk_id não existe, por isso é falha ao atualizar',
