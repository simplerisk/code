...
$lang = array(
    ...
    'EmailTemplateSendingAssessment' => '
        <html><body> \\ n 안녕하세요, \\n <p> {$username} 다음과 같은 위험 평가 설문 조사를 완료 하려면 aksed 있다:</p> \\ n <p><a href="{$assessment_link}"> {$assessment_name} </a></p> \\ n <p>이 자동화 된 메시지 이며 응답은 무시 되거나 거부 됩니다. </p> \\ n </body></html>',
    ...
    'RiskIDNoEXitFailedToUpdate' => '위험 ID $risk_id , 그래서 그것을 업데이 트 하는 faild 존재 하지 않습니다',
