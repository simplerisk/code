...
$lang = array(
    ...
    'NoPermissionForThisAction'=>'Sinulla ei ole lupaa tähän toimintoon.',
    ...
    'WorkflowHttpRequestDisallowedURL' => '{$action}: URL-osoite {$url} selvittää kiellettyyn sisäiseen tai varattuun osoitteeseen.',
    ...
    'WorkflowsExtraDeactivateConfirm' => 'Poistetaanko Työnkulut-lisäominaisuus käytöstä? Kaikki työnkulkumääritelmät, mukaan lukien oletusarvoiset järjestelmän työnkulut, poistetaan pysyvästi. Lisäominaisuuden uudelleenaktivointi luo uudelleen oletusarvoiset järjestelmän työnkulut, mutta niihin tehdyt mukautukset menetetään.',
    ...
    'NewUsernameAddedWithTemporaryPassword' => 'Uusi käyttäjä käyttäjätunnuksella "{$username}" lisättiin onnistuneesti. Väliaikainen salasana: {$password} (käyttäjän on vaihdettava se ensimmäisen kirjautumisen yhteydessä).',
    'YouDontHavePermission' => 'Sinulla ei ole käyttöoikeutta.',
    // Initiate Audits bulk-select
    'InitiatedTestsBulk' => 'Käynnistettiin $count testejä.',
    // Merged Audits page (replaces Active Audits + Past Audits menu items)
    'Audits' => 'Tarkastukset',
    'ManageAudits' => 'Hallinnoi tarkastuksia',
    'ViewAudits' => 'Näytä auditoinnit',
    // Redesigned, flat Initiate Audits page
    'EligibleTests' => 'Kelvollisia testejä',
    'InitiateSelected' => 'Aloita valitut',
    'InitiateNAudits' => 'Aloita {n} auditointeja',
    'TagsOptionalAppliedToSelection' => 'Tagit (valinnainen, käytetään kaikkiin)',
    'Initiate' => 'Aloita',
    'NoEligibleTestsFound' => 'Ei löytynyt kelvollisia testejä.',
    'Columns' => 'Sarakkeet',
    'ShowTestsWithAuditInProgress' => 'Näytä testit, joiden tarkastus on käynnissä',
    'NoMatchingOptions' => 'Ei vastaavia vaihtoehtoja.',
    'TestDetails' => 'Testin tiedot',
    'PeopleAndTeams' => 'Ihmiset ja tiimit',
    'StatusAndTimeline' => 'Tila ja aikajana',
    'DataIntegrityTextEncoding' => 'Tekstin koodaus',
    'DataIntegrityFileEncoding' => 'Tiedostokoodaus',
    'DataIntegrity' => 'Tietojen eheys',
    'DataIntegrityDesc' => 'Tarkista ja korjaa vioittuneita tai virheellisiä tietoja sisältävät tiedot.',
    'ScanNow' => 'Skannaa nyt',
    'BrokenValue' => 'Rikkoutunut arvo',
    'SuggestedFix' => 'Ehdotettu korjaus',
    'RepairSelected' => 'Korjaa valittu',
    'DataIntegrityAllCaughtUpTitle' => 'Kaikki ajan tasalla',
    'DataIntegrityAllCaughtUpBody' => 'Kaikki tietojen eheysongelmia on ratkaistu. Tietosi ovat puhtaat.',
    'Repair' => 'Korjaus',
    'DataIntegrityTotalCount' => 'Ongelmia yhteensä',
    'DataIntegrityHealthCheckFailed' => '%d tietuetta/tietueita on korjattava. Tarkista ne Asetukset-valikon Tietojen eheys -sivulta.',
    'DataIntegrityRecordLocation' => 'Tietue:',
    'DataIntegrityNotificationTitle' => 'Tietojen eheysongelmia löydetty',
    'DataIntegrityNotificationBody' => 'Tietojen eheystarkistus löysi korjattavia tietueita.',
    'DataIntegrityShowingCapped' => 'Näytetään {n} / {total}.',
    ...
    'CouldNotLoadMappedFrameworks' => 'Yhdistettyjen kehysten lataaminen epäonnistui.',
    'NoMappedFrameworksFound' => 'Yhdistettyjä kehyksiä ei löytynyt.',
    'SearchMappedFrameworks' => 'Hae kehyksiä tai ohjaimia',
    'CommentNotAddedToAudit' => 'Kommenttiasi ei voitu lisätä tarkastukseen.',
    'AssetIdsRequired' => 'VIRHEELLINEN PYYNTÖ: asset_ids[] on pakollinen.',
    'TheDefaultBusinessUnitCannotBeDeleted' => 'Oletusliiketoimintayksikköä ei voi poistaa.',
    ...
    'OtherSessionsNotCleared' => 'Muita aktiivisia istuntoja ei voitu tyhjentää, ja ne pysyvät kirjautuneina, kunnes ne vanhenevat.',
    'BackupCannotResolveInstallDir' => 'Varmuuskopion SimpleRisk-asennushakemistoa ei voitu selvittää.',
    'BackupTargetChangedOrExists' => 'Varmuuskopion kirjoittaminen hakemistoon "{$dir}" hylättiin: kohde muuttui odottamatta tai se on jo olemassa.',
    'BackupDirectoryUnsafe' => 'Kieltäydytään käyttämästä varmuuskopiohakemistoa "{$location}": se on symlink tai toisen tilin omistuksessa.',
    'DocumentAuditLogApprove' => 'Asiakirja "{$document_name}" hyväksyttiin käyttäjän {$user} toimesta.',
    'DocumentAuditLogUnapprove' => '{$user} hylkäsi dokumentin "{$document_name}" .',
    'NoApproveDocumentationPermission' => 'Sinulla ei ole oikeutta hyväksyä asiakirjoja.',
    'DocumentApproved' => 'Asiakirja hyväksyttiin.',
    'DocumentUnapproved' => 'Asiakirjaa ei hyväksytty.',
    'DocumentsApproved' => 'Asiakirjat hyväksyttiin.',
    'ApproveSelected' => 'Hyväksy valitut',
    'SearchDocumentsPlaceholder' => 'Hae asiakirjoja',
    'NoDocumentsYet' => 'Ei vielä asiakirjoja',
    'NoDocumentsYetBody' => 'Tähän luokkaan lisätyt asiakirjat näkyvät tässä.',
    'NoDocumentsMatchFilters' => 'Hakuasi vastaavia asiakirjoja ei löytynyt',
    'NoDocumentsMatchFiltersBody' => 'Kokeile eri hakusanaa tai vaihda kategoriaa.',
    'CouldNotLoadDocuments' => 'Asiakirjoja ei voitu ladata',
    'CouldNotLoadDocumentsBody' => 'Tiedosto-ohjelman ruudukon lataamisessa tapahtui virhe.',
    'ApproveDocumentQuestion' => 'Hyväksytäänkö tämä asiakirja?',
    'ApproveDocumentConfirmBody' => 'Tämä asettaa "{name}" arvoksi Hyväksytty ja laskee sen seuraavan tarkistuspäivämäärän.',
    'UnapproveDocumentQuestion' => 'Perutaanko tämän asiakirjan hyväksyntä?',
    'UnapproveDocumentConfirmBody' => 'Tämä lähettää "{name}" takaisin Tarkistuksessa-tilaan.',
    'ApproveSelectedDocumentsQuestion' => 'Hyväksytäänkö {n} valitut asiakirjat?',
    'ApproveSelectedDocumentsConfirmBody' => 'Tämä hyväksyy {n} valitut asiakirjat ja laskee kunkin seuraavan tarkistuspäivämäärän.',
    'AddCategory' => 'Lisää luokka',
    'ExceptionsApproved' => 'Poikkeukset hyväksyttiin.',
    'FrameworkControl' => 'Kehys / Ohjaus',
    'NoExceptionsYet' => 'Ei vielä poikkeuksia',
    'NoExceptionsYetBody' => 'Lisäämäsi poikkeukset näkyvät tässä.',
    'NoExceptionsMatchFilters' => 'Hakuasi vastaavia poikkeuksia ei löytynyt',
    'NoExceptionsMatchFiltersBody' => 'Kokeile toista hakusanaa tai tyhjennä hakusi.',
    'CouldNotLoadExceptions' => 'Poikkeusten lataaminen epäonnistui',
    'CouldNotLoadExceptionsBody' => 'Määritä poikkeukset -ruudukon lataamisessa tapahtui virhe.',
    'ApproveExceptionQuestion' => 'Hyväksytäänkö tämä poikkeus?',
    'ApproveExceptionConfirmBody' => 'Tämä asettaa "{name}" arvoksi Hyväksytty.',
    'UnapproveExceptionQuestion' => 'Perutaanko tämä poikkeus?',
    'UnapproveExceptionConfirmBody' => 'Tämä lähettää "{name}" takaisin odottavaan tilaan.',
    'ApproveSelectedExceptionsQuestion' => 'Hyväksytäänkö {n} valitut poikkeukset?',
    'ApproveSelectedExceptionsConfirmBody' => 'Tämä hyväksyy {n} valitut poikkeukset.',
    'SearchExceptionsPlaceholder' => 'Hae poikkeuksia...',
    'DeleteSelected' => 'Poista valitut',
    'ExceptionsDeleted' => 'Valitut poikkeukset poistettiin.',
    'GovernanceReviewDueEmailSubject' => 'Arvioinnin määräaika: {$name}',
    'GovernanceReviewDueEmailBody' => '{$name} on määrä tarkistaa.',
    'DocumentDetails' => 'Asiakirjan tiedot',
    'WhereItApplies' => 'Missä se soveltuu',
    'WhoIsInvolved' => "Ketkä ovat mukana",
    'ReviewCadence' => 'Tarkistustiheys',
    'ExceptionDetails' => 'Poikkeuksen tiedot',
    'DescriptionJustification' => 'Kuvaus ja perustelu',
    'ChooseAControl' => 'Valitse ohjausobjekti',
    'CantDeleteDocumentCategoryInUse' => 'Tätä asiakirjatyyppiä ei voida poistaa, koska sen alle on arkistoitu muita asiakirjoja.',
    'ExceptionDoesNotExist' => 'Asiakirjapoikkeusta ei ole olemassa',
    'DocumentAuditTrailReport' => 'Asiakirjan tarkastusketjuraportti',
    'PastWeek' => 'Viime viikko',
    'PastMonth' => 'Viime kuukausi',
    'PastQuarter' => 'Viime neljännes',
    'Past6Months' => 'Viimeiset 6 kuukautta',
    'PastYear' => 'Viime vuonna',
    'CantRenameSeededDocumentCategory' => 'Sisäänrakennettuja asiakirjatyyppejä ei voi nimetä uudelleen, koska SimpleRiskin muut osat viittaavat niihin niiden alkuperäisillä nimillä. Voit lisätä omia tyyppejä ja nimetä ne uudelleen vapaasti.',
    'DocumentsApprovedTruncated' => 'Vain ensimmäiset {$limit} valitut asiakirjat hyväksyttiin. Toista toiminto hyväksyäksesi loput.',
    'ExceptionsApprovedTruncated' => 'Vain ensimmäiset {$limit} valittua poikkeusta hyväksyttiin. Toista toiminto hyväksyäksesi loput.',
    'AreYouSureYouWantToDeleteTheseDocuments' => 'Haluatko varmasti poistaa nämä asiakirjat?',
    'DocumentsDeleted' => 'Valitut asiakirjat poistettiin.',
    'AllApprovers' => 'Kaikki hyväksyjät',
    'NotScheduled' => 'Ei aikataulutettu',
    'LastReviewDate' => 'Viimeisin tarkistuspäivämäärä',
    'DocumentAuditLogDownload' => 'Käyttäjä {$user} latasi asiakirjan "{$document_name}".',
    'Refresh' => 'Päivitä',
    'AuditTrailDateAndTime' => 'Päivämäärä ja aika',
    'Activity' => 'Toiminta',
    'Updated' => 'Päivitetty',
    'Deleted' => 'Poistettu',
    'Downloaded' => 'Ladattu',
    'Uploaded' => 'Ladattu',
    'AllDocuments' => 'Kaikki asiakirjat',
    'AllUsers' => 'Kaikki käyttäjät',
    'SearchAuditTrailPlaceholder' => 'Etsi tarkistuslokilta',
    'NoAuditLogEntries' => 'Ei vielä tarkastuslokin merkintöjä',
    'NoAuditLogEntriesBody' => 'Tämän sivun dokumenttien toiminta näkyy täällä.',
    'NoAuditLogEntriesMatchFilters' => 'Hakuasi vastaavia merkintöjä ei löytynyt',
    'NoAuditLogEntriesMatchFiltersBody' => 'Kokeile eri hakutermiä, ajanjaksoa tai suodatinta.',
    'By' => 'toimesta',
    'UnknownUser' => 'Tuntematon käyttäjä',
    'AllActivities' => 'Kaikki aktiviteetit',
    'DownloadSelected' => 'Lataa valitut',
    'NoDocumentsSelectedForDownload' => 'Yhtään dokumenttia ei valittu ladattavaksi.',
    'DocumentsDownloadTruncated' => 'Vain ensimmäiset {$limit} valittua dokumenttia sisällytettiin lataukseen. Toista toiminto ladataksesi loput.',
    'NoDownloadableDocumentsSelected' => 'Yhdelläkään valituista dokumenteista ei ole ladattavaa tiedostoa.',
    'VersionHistory' => 'Versiohistoria',
    'Current' => 'Nykyinen',
    'DeleteVersion' => 'Poista tämä versio',
    'ConfirmDeleteVersionQuestion' => 'Poistetaanko tämä tiedostoversio?',
    'ConfirmDeleteVersionConfirmBody' => 'Tämä poistaa vain tämän historiallisen tiedostoversion. Dokumentti ja sen nykyinen tiedosto eivät muutu.',
    'CannotDeleteCurrentDocumentVersion' => 'Dokumentin nykyistä versiota ei voida poistaa tällä tavalla. Käytä sen sijaan itse dokumentin Poista-toimintoa.',
    'DocumentVersionDeleted' => 'Asiakirjan versio on poistettu.',
    'DeletedVersion' => 'Versio poistettu',
    'CouldNotLoadVersionHistory' => 'Versiohistorian lataaminen epäonnistui.',
    'DocumentsOverdueForReview' => 'Tarkistukseen erääntyneet asiakirjat',
    'DocumentsDueSoonForReview' => 'Pian tarkastettavaksi määräaikaiset asiakirjat',
    'RequiresCustomizationExtra' => 'Vaatii mukautuslisäosan.',
    'UnlockCustomizationLink' => 'Katso, mitä se lisää',
    'UnlockActivateCustomizationNote' => 'Mukautuslisäosa on asennettu, mutta sitä ei ole otettu käyttöön.',
    'UnlockActivateCustomizationLink' => 'Käynnistä se',
    'ExceptionsOverdueForReview' => 'Tarkistukseen myöhässä olevat poikkeukset',
    'ExceptionsDueSoonForReview' => 'Pian tarkastettavaksi määräaikaiset poikkeukset',
    'PendingApproval' => 'Odottaa hyväksyntää',
    'AllExceptions' => 'Kaikki poikkeukset',
    'AllStates' => 'Kaikki tilat',
    'DocumentDoesNotExist' => 'Dokumenttia ei ole olemassa',
    'SomeExceptionsNotDeleted' => 'Joitakin valittuja poikkeuksia ei voitu poistaa. Päivitä sivu ja yritä uudelleen.',
    'SomeDocumentsNotDeleted' => 'Joitakin valittuja asiakirjoja ei voitu poistaa. Päivitä sivu ja yritä uudelleen.',
    // Scheduled report "Run Now" success alerts (process_run_now_notification())
    'AutomatedNotificationOfRisksSent' => 'Automaattinen ilmoitus tarkastamattomista ja erääntyneistä riskeistä on lähetetty.',
    'AutomatedNotificationOfAuditsSent' => 'Automaattinen ilmoitus tarkastuksista on lähetetty.',
    'AutomatedNotificationOfMitigationsSent' => 'Automaattinen ilmoitus lieventämistoimista on lähetetty.',
    'AutomatedNotificationOfUnmitigatedRisksSent' => 'Automaattinen ilmoitus lieventämättömistä riskeistä on lähetetty.',
    'AutomatedNotificationOfPolicyControlExceptionsSent' => 'Automaattinen ilmoitus tarkistamattomista ja myöhästyneistä käytäntö- ja valvontapoikkeuksista on lähetetty.',
    'AutomatedNotificationOfDocumentReviewsSent' => 'Automaattinen ilmoitus asiakirjojen tarkistuksista on lähetetty.',
    'NoWorkflowsDefinedYet' => 'Työnkulkuja ei ole vielä määritelty. Luo uusi napsauttamalla Uusi työnkulku.',
    'NoPermissionToViewDocumentation' => 'Sinulla ei ole oikeutta tarkastella dokumentaatiota',
    'AddDocumentType' => 'Lisää asiakirjatyyppi',
    'BuiltIn' => 'Sisäänrakennettu',
    'TemplateGroups' => 'Malliryhmät',
    'ManageDocumentTypes' => 'Hallitse asiakirjatyyppejä',
    'NeedANewCategoryManageDocumentTypes' => 'Tarvitsetko uuden kategorian?',
    'ManageOptions' => 'Hallinnoi vaihtoehtoja',
    'AddCustomFieldSubtitle' => 'Lisää mukautettuja kenttiä tallentaaksesi tälle kenttäryhmälle ominaisia tietoja.',
    'NewField' => 'Uusi kenttä',
    'TemplateGroupsSectionSubtitle' => 'Luo lisää malliryhmiä ja määritä ne liiketoimintayksiköille.',
    'TemplateSectionSubtitle' => 'Valitse, mitkä kentät näkyvät tässä mallissa ja missä järjestyksessä.',
    'CustomFieldsSectionSubtitle' => 'Kaikki tälle kenttäryhmälle määritetyt mukautetut kentät kaikissa malleissa.',
    'CantDeleteSeededDocumentCategory' => 'Sisäänrakennettuja asiakirjatyyppejä ei voi poistaa, koska SimpleRiskin muut osat viittaavat niihin niiden alkuperäisillä nimillä. Voit lisätä omia tyyppejäsi ja poistaa niitä vapaasti.',
    'FieldGroupSelectorSubtitle' => 'Valitse, minkä kenttäryhmän kenttiä ja malleja haluat mukauttaa.',
    'CloneTemplateGroup' => 'Kloonaa tämä malliryhmä',
    'RequiredFieldCheckboxLabel' => 'Tee tästä mukautetusta kentästä pakollinen.',
    'AddField' => 'Lisää kenttä',
    'CoreFields' => 'Ydinkentät',
    'SearchCoreFields' => 'Hae ydinkenttiä',
    'SearchCustomFields' => 'Hae mukautettuja kenttiä',
    'AllCoreFieldsAddedToTab' => 'Kaikki ydinkentät ovat tässä välilehdessä.',
    'AllCustomFieldsAddedToTemplate' => 'Kaikki mukautetut kentät ovat tässä mallissa.',
    'NoFieldsMatchSearchTerm' => 'Yhtään kenttää ei vastaa hakua "{term}".',
    'NoCustomFieldsYet' => 'Ei vielä mukautettuja kenttiä -- luo sellainen alle käyttääksesi sitä tässä mallissa.',
    'AddFieldsToPrefix' => 'Lisää kenttiä kohteeseen',
    'AddFieldsHeading' => 'Lisää kenttiä',
    'FieldPickerHint' => 'Kentän napsauttaminen lisää sen suoraan alla olevaan asetteluun. Ei mitään vahvistettavaa.',
    'Done' => 'Tehty',
    'FieldAddedToTab' => 'Lisätty {field} kohtaan {tab}.',
    'FieldRemovedBackToList' => 'Poistettu {field} -- se on takaisin listalla.',
    'NowAddingToTab' => 'Lisätään nyt kohtaan {tab}.',
    'PickFieldToAdd' => 'Valitse kenttä jommastakummasta sarakkeesta lisätäksesi sen.',
