...
$lang = array(
    ...
    'EmailTemplateSendingAssessment' => '
        <html><body> \\ n Hello, \\n <p> {$username} aşağıdaki risk değerlendirme anketini Aksed:</p> \\ n <p><a href="{$assessment_link}"> {$assessment_name} </a></p> \\ n <p>This otomatik bir iletidir ve yanıt yoksayılır veya reddedilir. </p> \\ n </body></html>',
    ...
    'RiskIDNoEXitFailedToUpdate' => 'Risk kimliği $risk_id yok, bu nedenle güncellemek için başarısız',
