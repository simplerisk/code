...
$lang = array(
    ...
    'NoPermissionForThisAction'=>'Bu işlemi gerçekleştirmek için izniniz yok.',
    ...
    'WorkflowHttpRequestDisallowedURL' => '{$action}: {$url} URL\'si, izin verilmeyen dahili veya ayrılmış bir adrese çözümleniyor.',
    ...
    'WorkflowsExtraDeactivateConfirm' => 'İş Akışları Ek Özelliğini devre dışı bırakmak mı istiyorsunuz? Varsayılan sistem iş akışları da dahil olmak üzere tüm iş akışı tanımları kalıcı olarak silinecektir. Ek Özelliği yeniden etkinleştirmek, varsayılan sistem iş akışlarını yeniden oluşturacaktır, ancak bunlara yapılan tüm özelleştirmeler kaybolacaktır.',
    ...
    'NewUsernameAddedWithTemporaryPassword' => '"{$username}" kullanıcı adına sahip yeni bir kullanıcı başarıyla eklendi. Geçici parola: {$password} (kullanıcı ilk girişinde bunu değiştirmelidir)',
    'YouDontHavePermission' => 'İzniniz yok.',
    // Initiate Audits bulk-select
    'InitiatedTestsBulk' => '$count test başlatıldı.',
    // Merged Audits page (replaces Active Audits + Past Audits menu items)
    'Audits' => 'Denetimler',
    'ManageAudits' => 'Denetimleri Yönetin',
    'ViewAudits' => 'Denetimleri Görüntüle',
    // Redesigned, flat Initiate Audits page
    'EligibleTests' => 'Uygun testler',
    'InitiateSelected' => 'Seçilenleri başlat',
    'InitiateNAudits' => '{n} denetimini başlat',
    'TagsOptionalAppliedToSelection' => 'Etiketler (isteğe bağlı, tümüne uygulanır)',
    'Initiate' => 'Başlat',
    'NoEligibleTestsFound' => 'Uygun test bulunamadı.',
    'Columns' => 'Sütunlar',
    'ShowTestsWithAuditInProgress' => 'Denetimi devam eden testleri göster',
    'NoMatchingOptions' => 'Eşleşen seçenek bulunamadı.',
    'TestDetails' => 'Test Detayları',
    'PeopleAndTeams' => 'İnsanlar ve Takımlar',
    'StatusAndTimeline' => 'Durum ve Zaman Çizelgesi',
    'DataIntegrityTextEncoding' => 'Metin Kodlaması',
    'DataIntegrityFileEncoding' => 'Dosya Kodlaması',
    'DataIntegrity' => 'Veri Bütünlüğü',
    'DataIntegrityDesc' => 'Bozuk veya geçersiz veriler içeren kayıtları inceleyin ve onarın.',
    'ScanNow' => 'Şimdi Tara',
    'BrokenValue' => 'Kırık Değer',
    'SuggestedFix' => 'Önerilen Çözüm',
    'RepairSelected' => 'Seçilenleri Onar',
    'DataIntegrityAllCaughtUpTitle' => 'Her şey tamamlandı.',
    'DataIntegrityAllCaughtUpBody' => 'Veri bütünlüğüyle ilgili herhangi bir sorun tespit edilmedi.',
    'Repair' => 'Onar',
    'DataIntegrityTotalCount' => 'toplam',
    'DataIntegrityHealthCheckFailed' => '%d kayıt onarılmaya ihtiyaç duyuyor. Bunları incelemek için Ayarlar altındaki Veri Bütünlüğü sayfasına gidin.',
    'DataIntegrityRecordLocation' => 'Kayıt:',
    'DataIntegrityNotificationTitle' => 'Veri bütünlüğü sorunları tespit edildi.',
    'DataIntegrityNotificationBody' => 'Veri Bütünlüğü taraması, onarılması gereken kayıtlar buldu.',
    'DataIntegrityShowingCapped' => '{total}\'ten {n} gösteriliyor.',
    ...
    'CouldNotLoadMappedFrameworks' => 'Eşleştirilmiş çerçeveler yüklenemedi.',
    'NoMappedFrameworksFound' => 'Eşleştirilmiş çerçeve bulunamadı.',
    'SearchMappedFrameworks' => 'Çerçeveleri veya kontrolleri ara',
    'CommentNotAddedToAudit' => 'Yorumunuz denetim kaydına eklenemedi.',
    'AssetIdsRequired' => 'HATALI İSTEK: asset_ids[] gereklidir.',
    'TheDefaultBusinessUnitCannotBeDeleted' => 'Varsayılan İş Birimi silinemez.',
    ...
    'OtherSessionsNotCleared' => 'Diğer aktif oturumlar temizlenemedi ve süreleri dolana kadar oturum açık kalacaktır.',
    'BackupCannotResolveInstallDir' => 'Yedekleme için SimpleRisk kurulum dizini çözümlenemedi.',
    'BackupTargetChangedOrExists' => 'Yedeklemenin "{$dir}" içine yazılması reddedildi: hedef beklenmedik şekilde değişti veya zaten mevcut.',
    'BackupDirectoryUnsafe' => '"{$location}" yedekleme dizinini kullanmayı reddediyorum: bu bir sembolik bağlantı veya başka bir hesaba ait.',
    'DocumentAuditLogApprove' => '"{$document_name}" belgesi {$user} tarafından onaylandı.',
    'DocumentAuditLogUnapprove' => '"{$document_name}" belgesi {$user} tarafından onaylanmadı.',
    'NoApproveDocumentationPermission' => 'Belgeleri onaylama yetkiniz yok.',
    'DocumentApproved' => 'Belge onaylandı.',
    'DocumentUnapproved' => 'Belge onaylanmadı.',
    'DocumentsApproved' => 'Belgeler onaylandı.',
    'ApproveSelected' => 'Seçilenleri onayla',
    'SearchDocumentsPlaceholder' => 'Arama belgeleri',
    'NoDocumentsYet' => 'Henüz hiçbir belge yok.',
    'NoDocumentsYetBody' => 'Bu kategoriye eklenen belgeler burada görünecektir.',
    'NoDocumentsMatchFilters' => 'Arama kriterlerinize uyan belge bulunamadı.',
    'NoDocumentsMatchFiltersBody' => 'Farklı bir arama terimi deneyin veya kategorileri değiştirin.',
    'CouldNotLoadDocuments' => 'Belgeler yüklenemedi.',
    'CouldNotLoadDocumentsBody' => 'Belge Programı tablosu yüklenirken bir sorun oluştu.',
    'ApproveDocumentQuestion' => 'Bu belgeyi onaylıyor musunuz?',
    'ApproveDocumentConfirmBody' => 'Bu, "{name}" öğesini Onaylandı olarak ayarlar ve bir sonraki inceleme tarihini hesaplar.',
    'UnapproveDocumentQuestion' => 'Bu belgeyi onaylamayı iptal etmek ister misiniz?',
    'UnapproveDocumentConfirmBody' => 'Bu, "{name}" ifadesini İncelemede bölümüne geri gönderir.',
    'ApproveSelectedDocumentsQuestion' => 'Seçilen {n} belgeyi onayla?',
    'ApproveSelectedDocumentsConfirmBody' => 'Bu işlem, seçilen {n} belgeyi onaylar ve her birinin bir sonraki inceleme tarihini hesaplar.',
    'AddCategory' => 'Kategori ekle',
    'ExceptionsApproved' => 'İstisnalar onaylandı.',
    'FrameworkControl' => 'Çerçeve / Kontrol',
    'NoExceptionsYet' => 'Henüz istisna yok.',
    'NoExceptionsYetBody' => 'Eklediğiniz istisnalar burada görünecektir.',
    'NoExceptionsMatchFilters' => 'Arama kriterlerinize uyan hiçbir istisna bulunmamaktadır.',
    'NoExceptionsMatchFiltersBody' => 'Farklı bir arama terimi deneyin veya aramanızı temizleyin.',
    'CouldNotLoadExceptions' => 'İstisnalar yüklenemedi.',
    'CouldNotLoadExceptionsBody' => 'İstisnaları Tanımla tablosu yüklenirken bir sorun oluştu.',
    'ApproveExceptionQuestion' => 'Bu istisnayı onaylıyor musunuz?',
    'ApproveExceptionConfirmBody' => 'Bu, "{name}" ifadesini Onaylandı olarak ayarlar.',
    'UnapproveExceptionQuestion' => 'Bu istisnayı onaylamamak mı istiyorsunuz?',
    'UnapproveExceptionConfirmBody' => 'Bu, "{name}" ifadesini Beklemede durumuna geri gönderir.',
    'ApproveSelectedExceptionsQuestion' => 'Approve {n} selected exceptions?',
    'ApproveSelectedExceptionsConfirmBody' => 'Bu, seçilen {n} istisnayı onaylar.',
    'SearchExceptionsPlaceholder' => 'Arama istisnaları...',
    'DeleteSelected' => 'Seçilenleri sil',
    'ExceptionsDeleted' => 'Seçilen istisnalar silindi.',
    'GovernanceReviewDueEmailSubject' => 'İnceleme tarihi: {$name}',
    'GovernanceReviewDueEmailBody' => '{$name} incelemeye alınmak üzere.',
    'DocumentDetails' => 'Belge detayları',
    'WhereItApplies' => 'Uygulandığı yerlerde',
    'WhoIsInvolved' => "Kimler dahil?",
    'ReviewCadence' => 'İnceleme ritmi',
    'ExceptionDetails' => 'İstisna ayrıntıları',
    'DescriptionJustification' => 'Açıklama ve gerekçe',
    'ChooseAControl' => 'Bir kontrol seçin',
    'CantDeleteDocumentCategoryInUse' => 'Bu belge türünü silemiyorum çünkü şu anda bu belge türü altında başka belgeler kayıtlı.',
    'ExceptionDoesNotExist' => 'Belge İstisnası Mevcut Değil',
    'DocumentAuditTrailReport' => 'Belge Denetim İzleme Raporu',
    'PastWeek' => 'Geçtiğimiz Hafta',
    'PastMonth' => 'Geçtiğimiz Ay',
    'PastQuarter' => 'Geçtiğimiz Çeyrek',
    'Past6Months' => 'Son 6 Ay',
    'PastYear' => 'Geçtiğimiz Yıl',
    'CantRenameSeededDocumentCategory' => 'Dahili belge türleri yeniden adlandırılamaz, çünkü SimpleRisk\'in diğer bölümleri bunlara orijinal adlarıyla atıfta bulunur. Kendi türlerinizi ekleyebilir ve bunları özgürce yeniden adlandırabilirsiniz.',
    'DocumentsApprovedTruncated' => 'Yalnızca ilk {$limit} seçili belge onaylandı. Geri kalanları onaylamak için lütfen işlemi tekrarlayın.',
    'ExceptionsApprovedTruncated' => 'Yalnızca seçilen ilk {$limit} istisna onaylandı. Geri kalanları onaylamak için lütfen işlemi tekrarlayın.',
    'AreYouSureYouWantToDeleteTheseDocuments' => 'Bu belgeleri silmek istediğinizden emin misiniz?',
    'DocumentsDeleted' => 'Seçilen belgeler silindi.',
    'AllApprovers' => 'Tüm onaylayıcılar',
    'NotScheduled' => 'Planlanmamış',
    'LastReviewDate' => 'Son İnceleme Tarihi',
    'DocumentAuditLogDownload' => '"{$document_name}" belgesi {$user} tarafından indirildi.',
    'Refresh' => 'Yenile',
    'AuditTrailDateAndTime' => 'Tarih ve Saat',
    'Activity' => 'Aktivite',
    'Updated' => 'Güncellendi',
    'Deleted' => 'Silindi',
    ...
    'SearchAuditTrailPlaceholder' => 'Arama denetim izi',
    'NoAuditLogEntries' => 'Henüz denetim günlüğü kaydı yok.',
    'NoAuditLogEntriesBody' => 'Bu sayfadaki belgelerle ilgili etkinlikler burada görünecektir.',
    'NoAuditLogEntriesMatchFilters' => 'Arama kriterlerinize uyan sonuç bulunamadı.',
    'NoAuditLogEntriesMatchFiltersBody' => 'Farklı bir arama terimi, tarih aralığı veya filtre deneyin.',
    'By' => 'ile',
    'UnknownUser' => 'Bilinmeyen kullanıcı',
    'AllActivities' => 'Tüm faaliyetler',
    'DownloadSelected' => 'Seçilenleri indir',
    'NoDocumentsSelectedForDownload' => 'İndirilmek üzere hiçbir belge seçilmedi.',
    'DocumentsDownloadTruncated' => 'Only the first {$limit} selected documents were included in the download. Please repeat the action to download the rest.',
    'NoDownloadableDocumentsSelected' => 'Seçilen belgelerin hiçbirinde indirilecek dosya bulunmamaktadır.',
    'VersionHistory' => 'Sürüm Geçmişi',
    'Current' => 'Akım',
    'DeleteVersion' => 'Bu sürümü sil',
    'ConfirmDeleteVersionQuestion' => 'Bu dosya sürümünü silmek mi istiyorsunuz?',
    'ConfirmDeleteVersionConfirmBody' => 'Bu işlem yalnızca dosyanın geçmiş sürümünü siler. Belge ve mevcut dosyası etkilenmez.',
    'CannotDeleteCurrentDocumentVersion' => 'Belgenin mevcut sürümü bu şekilde silinemez. Bunun yerine, belgenin kendisinde bulunan Sil eylemini kullanın.',
    'DocumentVersionDeleted' => 'Belge sürümü silindi.',
    'DeletedVersion' => 'Sürüm silindi',
    'CouldNotLoadVersionHistory' => 'Sürüm geçmişi yüklenemedi.',
    'DocumentsOverdueForReview' => 'İnceleme Süresi Geçmiş Belgeler',
    'DocumentsDueSoonForReview' => 'İnceleme için belgelerin teslim tarihi yakında.',
    'RequiresCustomizationExtra' => 'Özelleştirme Ekstrası gereklidir.',
    'UnlockCustomizationLink' => 'Neler kattığına bakın.',
    'UnlockActivateCustomizationNote' => 'Özelleştirme Ekstrası yüklendi ancak etkinleştirilmedi.',
    'UnlockActivateCustomizationLink' => 'Açın',
    'ExceptionsOverdueForReview' => 'İnceleme Süresi Geçmiş İstisnalar',
    'ExceptionsDueSoonForReview' => 'İstisnalar Yakında İncelenecek',
    'PendingApproval' => 'Onay Bekleniyor',
    'AllExceptions' => 'Tüm İstisnalar',
    'AllStates' => 'Tüm eyaletler',
    'DocumentDoesNotExist' => 'Belge mevcut değil.',
    'SomeExceptionsNotDeleted' => 'Seçilen istisnalardan bazıları silinemedi. Lütfen sayfayı yenileyip tekrar deneyin.',
    'SomeDocumentsNotDeleted' => 'Seçilen belgelerden bazıları silinemedi. Lütfen sayfayı yenileyip tekrar deneyin.',
    // Scheduled report "Run Now" success alerts (process_run_now_notification())
    'AutomatedNotificationOfRisksSent' => 'Henüz incelenmemiş ve vadesi geçmiş risklere ilişkin otomatik bildirim gönderildi.',
    'AutomatedNotificationOfAuditsSent' => 'Denetimlerle ilgili otomatik bildirim gönderildi.',
    'AutomatedNotificationOfMitigationsSent' => 'Risk azaltma önlemlerine ilişkin otomatik bildirim gönderildi.',
    'AutomatedNotificationOfUnmitigatedRisksSent' => 'Azaltılmamış risklere ilişkin otomatik bildirim gönderildi.',
    'AutomatedNotificationOfPolicyControlExceptionsSent' => 'Gözden geçirilmemiş ve vadesi geçmiş politika ve kontrol istisnalarına ilişkin otomatik bildirim gönderildi.',
    'AutomatedNotificationOfDocumentReviewsSent' => 'Belge incelemelerine ilişkin otomatik bildirim gönderildi.',
    'NoWorkflowsDefinedYet' => 'Henüz tanımlanmış iş akışı yok. Bir iş akışı oluşturmak için Yeni İş Akışı\'na tıklayın.',
    'NoPermissionToViewDocumentation' => 'Dokümantasyonu görüntüleme izniniz yok.',
    'AddDocumentType' => 'Belge türü ekle',
    'BuiltIn' => 'Dahili',
    'TemplateGroups' => 'Şablon Grupları',
    'ManageDocumentTypes' => 'Belge türlerini yönetin',
    'NeedANewCategoryManageDocumentTypes' => 'Yeni bir kategoriye mi ihtiyacınız var?',
    'ManageOptions' => 'Seçenekleri Yönet',
    'AddCustomFieldSubtitle' => 'Bu alan grubuna özgü bilgileri yakalamak için özel alanlar ekleyin.',
    'NewField' => 'Yeni Saha',
    'TemplateGroupsSectionSubtitle' => 'Ek şablon grupları oluşturun ve bunları iş birimlerine atayın.',
    'TemplateSectionSubtitle' => 'Bu şablonda hangi alanların görüneceğini ve hangi sırayla görüneceğini seçin.',
    'CustomFieldsSectionSubtitle' => 'Bu alan grubu için tanımlanmış tüm özel alanlar, her şablonda geçerlidir.',
    'CantDeleteSeededDocumentCategory' => 'Dahili belge türleri silinemez, çünkü SimpleRisk\'in diğer bölümleri bunlara orijinal adlarıyla atıfta bulunur. Kendi türlerinizi ekleyebilir ve bunları serbestçe silebilirsiniz.',
    'FieldGroupSelectorSubtitle' => 'Hangi alan grubunun alanlarını ve şablonlarını özelleştirmek istediğinizi seçin.',
    'CloneTemplateGroup' => 'Bu şablon grubunu klonlayın',
    'RequiredFieldCheckboxLabel' => 'Bu özel alanı zorunlu hale getirin.',
    'AddField' => 'Alan Ekle',
    'CoreFields' => 'Temel Alanlar',
    'SearchCoreFields' => 'Arama çekirdek alanları',
    'SearchCustomFields' => 'Arama özel alanları',
    'AllCoreFieldsAddedToTab' => 'Tüm temel alanlar bu sekmede yer almaktadır.',
    'AllCustomFieldsAddedToTemplate' => 'Tüm özel alanlar bu şablonda yer almaktadır.',
    'NoFieldsMatchSearchTerm' => '"{term} " ile eşleşen alan yok.',
    'NoCustomFieldsYet' => 'Henüz özel alan yok -- bu şablonda kullanmak için aşağıdan bir tane oluşturun.',
    'AddFieldsToPrefix' => 'Alanlar ekle',
    'AddFieldsHeading' => 'Alan ekle',
    'FieldPickerHint' => 'Bir alana tıkladığınızda, o alan doğrudan aşağıdaki düzene eklenir. Onaylamanız gereken bir şey yok.',
    'Done' => 'Tamamlamak',
    'FieldAddedToTab' => '{tab}\'e {field} eklendi.',
    'FieldRemovedBackToList' => '{field} kaldırıldı -- tekrar listede yer alıyor.',
    'NowAddingToTab' => 'Şimdi {tab}\'ya ekleniyor.',
    'PickFieldToAdd' => 'Eklemek istediğiniz alanı sütunlardan birinden seçin.',
    'NewCustomField' => 'Yeni özel alan',
