...
$lang = array(
    ...
    'Ordering' => 'Παραγγελία',
    'EncryptionKeyNoExist' => 'Το αρχείο κλειδιού Enryption δεν υπάρχει. Παρακαλώ επικοινωνήστε με το admin.',
    ...
    'RiskSubmitSuccess' => 'Κίνδυνο{$subject}επιτυχία.',
    'Accepting' => 'Αποδοχή...',
    'Rejecting' => 'Απόρριψη...',
    ...
    'WarnMySQLUploadSize' => 'ΠΡΟΕΙΔΟΠΟΙΗΣΗ: το τρέχον όριο μεγέθους αρχείου είναι μεγαλύτερο από το MySQL έχει ρυθμιστεί για προσθήκες.  Ελέγξτε τις τιμές max_allowed_packet και innodb_log_file_size στο αρχείο my. ncf.',
    'Restore' => 'Επαναφορά',
    '' => '',
);
