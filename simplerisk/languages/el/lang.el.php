...
$lang = array(
    ...
    'NoPermissionForThisAction'=>'Δεν έχετε άδεια για αυτήν την ενέργεια.',
    ...
    'WorkflowHttpRequestDisallowedURL' => '{$action}: Η διεύθυνση URL {$url} καταλήγει σε μια μη επιτρεπόμενη εσωτερική ή δεσμευμένη διεύθυνση.',
    ...
    'WorkflowsExtraDeactivateConfirm' => 'Απενεργοποίηση του Workflows Extra; Όλοι οι ορισμοί ροής εργασίας, συμπεριλαμβανομένων των προεπιλεγμένων ροών εργασίας συστήματος, θα διαγραφούν οριστικά. Η επανενεργοποίηση του Extra θα αναδημιουργήσει τις προεπιλεγμένες ροές εργασίας συστήματος, αλλά τυχόν προσαρμογές σε αυτές θα χαθούν.',
    ...
    'NewUsernameAddedWithTemporaryPassword' => 'Ένας νέος χρήστης με όνομα χρήστη "{$username}" προστέθηκε με επιτυχία. Προσωρινός κωδικός πρόσβασης: {$password} (ο χρήστης πρέπει να τον αλλάξει κατά την πρώτη σύνδεση).',
    'YouDontHavePermission' => 'Δεν έχετε άδεια πρόσβασης.',
    // Initiate Audits bulk-select
    'InitiatedTestsBulk' => 'Ξεκίνησαν δοκιμές $count.',
    // Merged Audits page (replaces Active Audits + Past Audits menu items)
    'Audits' => 'Έλεγχοι',
    'ManageAudits' => 'Διαχείριση ελέγχων',
    'ViewAudits' => 'Προβολή ελέγχων',
    // Redesigned, flat Initiate Audits page
    'EligibleTests' => 'Επιλέξιμες δοκιμές',
    'InitiateSelected' => 'Έναρξη επιλεγμένων',
    'InitiateNAudits' => 'Έναρξη ελέγχων {n}',
    'TagsOptionalAppliedToSelection' => 'Ετικέτες (προαιρετικά, εφαρμόζονται σε όλα)',
    'Initiate' => 'Έναρξη',
    'NoEligibleTestsFound' => 'Δεν βρέθηκαν κατάλληλες δοκιμές.',
    'Columns' => 'Στήλες',
    'ShowTestsWithAuditInProgress' => 'Εμφάνιση δοκιμών με έλεγχο σε εξέλιξη',
    'NoMatchingOptions' => 'Δεν υπάρχουν αντίστοιχες επιλογές.',
    'TestDetails' => 'Λεπτομέρειες δοκιμής',
    'PeopleAndTeams' => 'Άνθρωποι και Ομάδες',
    'StatusAndTimeline' => 'Κατάσταση και Χρονολόγιο',
    'DataIntegrityTextEncoding' => 'Κωδικοποίηση κειμένου',
    'DataIntegrityFileEncoding' => 'Κωδικοποίηση Αρχείου',
    'DataIntegrity' => 'Ακεραιότητα Δεδομένων',
    'DataIntegrityDesc' => 'Ελέγξτε και διορθώστε εγγραφές με κατεστραμμένα ή μη έγκυρα δεδομένα.',
    'ScanNow' => 'Σάρωση τώρα',
    'BrokenValue' => 'Κατεστραμμένη Τιμή',
    'SuggestedFix' => 'Προτεινόμενη διόρθωση',
    'RepairSelected' => 'Επιδιόρθωση επιλεγμένων',
    'DataIntegrityAllCaughtUpTitle' => 'Όλα είναι ενημερωμένα',
    'DataIntegrityAllCaughtUpBody' => 'Δεν βρέθηκαν προβλήματα ακεραιότητας δεδομένων.',
    'Repair' => 'Διόρθωση',
    'DataIntegrityTotalCount' => 'σύνολο',
    'DataIntegrityHealthCheckFailed' => '%d εγγραφή/εγγραφές χρειάζεται/χρειάζονται διόρθωση. Επισκεφτείτε τη σελίδα Ακεραιότητα Δεδομένων στις Ρυθμίσεις για να τις ελέγξετε.',
    'DataIntegrityRecordLocation' => 'Εγγραφή:',
    'DataIntegrityNotificationTitle' => 'Εντοπίστηκαν προβλήματα ακεραιότητας δεδομένων',
    'DataIntegrityNotificationBody' => 'Η σάρωση ακεραιότητας δεδομένων εντόπισε εγγραφές που χρειάζονται διόρθωση.',
    'DataIntegrityShowingCapped' => 'Εμφάνιση {n} από {total}.',
    ...
    'CouldNotLoadMappedFrameworks' => 'Αδύνατη η φόρτωση αντιστοιχισμένων πλαισίων.',
    'NoMappedFrameworksFound' => 'Δεν βρέθηκαν αντιστοιχισμένα πλαίσια.',
    'SearchMappedFrameworks' => 'Αναζήτηση πλαισίων ή στοιχείων ελέγχου',
    'CommentNotAddedToAudit' => 'Το σχόλιό σας δεν ήταν δυνατό να προστεθεί στον έλεγχο.',
    'AssetIdsRequired' => 'ΚΑΚΟ ΑΙΤΗΜΑ: απαιτείται το asset_ids[].',
    'TheDefaultBusinessUnitCannotBeDeleted' => 'Η προεπιλεγμένη επιχειρηματική μονάδα δεν μπορεί να διαγραφεί.',
    ...
    'OtherSessionsNotCleared' => 'Δεν ήταν δυνατή η εκκαθάριση άλλων ενεργών περιόδων σύνδεσης και θα παραμείνουν συνδεδεμένοι μέχρι να λήξουν.',
    'BackupCannotResolveInstallDir' => 'Δεν είναι δυνατή η επίλυση του καταλόγου εγκατάστασης του SimpleRisk για το αντίγραφο ασφαλείας.',
    'BackupTargetChangedOrExists' => 'Άρνηση εγγραφής του αντιγράφου ασφαλείας στο "{$dir}": ο στόχος άλλαξε απροσδόκητα ή υπάρχει ήδη.',
    'BackupDirectoryUnsafe' => 'Άρνηση χρήσης του καταλόγου αντιγράφων ασφαλείας "{$location}": είναι συμβολικός σύνδεσμος ή ανήκει σε άλλον λογαριασμό.',
    'DocumentAuditLogApprove' => 'Το έγγραφο "{$document_name}" εγκρίθηκε από τον/την {$user}.',
    'DocumentAuditLogUnapprove' => 'Το έγγραφο "{$document_name}" δεν εγκρίθηκε από τον χρήστη {$user}.',
    'NoApproveDocumentationPermission' => 'Δεν έχετε άδεια να εγκρίνετε έγγραφα.',
    'DocumentApproved' => 'Το έγγραφο εγκρίθηκε.',
    'DocumentUnapproved' => 'Το έγγραφο δεν εγκρίθηκε.',
    'DocumentsApproved' => 'Τα έγγραφα εγκρίθηκαν.',
    'ApproveSelected' => 'Έγκριση επιλεγμένων',
    'SearchDocumentsPlaceholder' => 'Αναζήτηση εγγράφων',
    'NoDocumentsYet' => 'Δεν υπάρχουν ακόμη έγγραφα',
    'NoDocumentsYetBody' => 'Τα έγγραφα που προστίθενται σε αυτήν την κατηγορία θα εμφανίζονται εδώ.',
    'NoDocumentsMatchFilters' => 'Δεν υπάρχουν έγγραφα που να αντιστοιχούν στην αναζήτησή σας',
    'NoDocumentsMatchFiltersBody' => 'Δοκιμάστε έναν διαφορετικό όρο αναζήτησης ή αλλάξτε κατηγορία.',
    'CouldNotLoadDocuments' => 'Δεν ήταν δυνατή η φόρτωση εγγράφων',
    'CouldNotLoadDocumentsBody' => 'Κάτι πήγε στραβά κατά τη φόρτωση του πλέγματος του Προγράμματος Εγγράφων.',
    'ApproveDocumentQuestion' => 'Έγκριση αυτού του εγγράφου;',
    'ApproveDocumentConfirmBody' => 'Αυτό ορίζει την τιμή "{name}" σε Εγκρίθηκε και υπολογίζει την ημερομηνία της επόμενης αναθεώρησης.',
    'UnapproveDocumentQuestion' => 'Να απορριφθεί η έγκριση αυτού του εγγράφου;',
    'UnapproveDocumentConfirmBody' => 'Αυτό στέλνει το "{name}" πίσω στην ενότητα "Σε Αναθεώρηση".',
    'ApproveSelectedDocumentsQuestion' => 'Έγκριση {n} επιλεγμένων εγγράφων;',
    'ApproveSelectedDocumentsConfirmBody' => 'Αυτό εγκρίνει {n} επιλεγμένα έγγραφα και υπολογίζει την επόμενη ημερομηνία αναθεώρησης για το καθένα.',
    'AddCategory' => 'Προσθήκη κατηγορίας',
    'ExceptionsApproved' => 'Οι εξαιρέσεις εγκρίθηκαν.',
    'FrameworkControl' => 'Πλαίσιο / Έλεγχος',
    'NoExceptionsYet' => 'Δεν υπάρχουν ακόμη εξαιρέσεις',
    'NoExceptionsYetBody' => 'Οι εξαιρέσεις που προσθέτετε θα εμφανίζονται εδώ.',
    'NoExceptionsMatchFilters' => 'Δεν υπάρχουν εξαιρέσεις που να αντιστοιχούν στην αναζήτησή σας',
    'NoExceptionsMatchFiltersBody' => 'Δοκιμάστε έναν διαφορετικό όρο αναζήτησης ή διαγράψτε την αναζήτησή σας.',
    'CouldNotLoadExceptions' => 'Δεν ήταν δυνατή η φόρτωση εξαιρέσεων',
    'CouldNotLoadExceptionsBody' => 'Παρουσιάστηκε κάποιο πρόβλημα κατά τη φόρτωση του πλέγματος "Ορισμός εξαιρέσεων".',
    'ApproveExceptionQuestion' => 'Έγκριση αυτής της εξαίρεσης;',
    'ApproveExceptionConfirmBody' => 'Αυτό ορίζει την τιμή "{name}" σε Εγκρίθηκε.',
    'UnapproveExceptionQuestion' => 'Να απορριφθεί αυτή η εξαίρεση;',
    'UnapproveExceptionConfirmBody' => 'Αυτό στέλνει το "{name}" πίσω στην κατάσταση "Σε εκκρεμότητα".',
    'ApproveSelectedExceptionsQuestion' => 'Έγκριση {n} επιλεγμένων εξαιρέσεων;',
    'ApproveSelectedExceptionsConfirmBody' => 'Αυτό εγκρίνει {n} επιλεγμένες εξαιρέσεις.',
    'SearchExceptionsPlaceholder' => 'Εξαιρέσεις αναζήτησης...',
    'DeleteSelected' => 'Διαγραφή επιλεγμένων',
    'ExceptionsDeleted' => 'Οι επιλεγμένες εξαιρέσεις διαγράφηκαν.',
    'GovernanceReviewDueEmailSubject' => 'Ο χρόνος αξιολόγησης είναι: {$name}',
    'GovernanceReviewDueEmailBody' => 'Το {$name} πρέπει να εξεταστεί.',
    'DocumentDetails' => 'Λεπτομέρειες εγγράφου',
    'WhereItApplies' => 'Πού εφαρμόζεται',
    'WhoIsInvolved' => "Ποιος εμπλέκεται",
    'ReviewCadence' => 'Αναθεώρηση ρυθμού',
    'ExceptionDetails' => 'Λεπτομέρειες εξαίρεσης',
    'DescriptionJustification' => 'Περιγραφή & αιτιολόγηση',
    'ChooseAControl' => 'Επιλέξτε ένα στοιχείο ελέγχου',
    'CantDeleteDocumentCategoryInUse' => 'Δεν είναι δυνατή η διαγραφή αυτού του τύπου εγγράφου, επειδή υπάρχουν έγγραφα που έχουν καταχωρηθεί αυτήν τη στιγμή με αυτόν τον τύπο.',
    'ExceptionDoesNotExist' => 'Η εξαίρεση εγγράφου δεν υπάρχει',
    'DocumentAuditTrailReport' => 'Αναφορά Ελέγχου Εγγράφων',
    'PastWeek' => 'Προηγούμενη εβδομάδα',
    'PastMonth' => 'Προηγούμενος μήνας',
    'PastQuarter' => 'Προηγούμενο τρίμηνο',
    'Past6Months' => 'Τελευταίοι 6 μήνες',
    'PastYear' => 'Προηγούμενο Έτος',
    'CantRenameSeededDocumentCategory' => 'Οι ενσωματωμένοι τύποι εγγράφων δεν μπορούν να μετονομαστούν, επειδή άλλα μέρη του SimpleRisk αναφέρονται σε αυτούς με τα αρχικά τους ονόματα. Μπορείτε να προσθέσετε τους δικούς σας τύπους και να τους μετονομάσετε ελεύθερα.',
    'DocumentsApprovedTruncated' => 'Μόνο τα πρώτα {$limit} επιλεγμένα έγγραφα εγκρίθηκαν. Επαναλάβετε την ενέργεια για να εγκρίνετε τα υπόλοιπα.',
    'ExceptionsApprovedTruncated' => 'Μόνο οι πρώτες {$limit} επιλεγμένες εξαιρέσεις εγκρίθηκαν. Επαναλάβετε την ενέργεια για να εγκρίνετε τις υπόλοιπες.',
    'AreYouSureYouWantToDeleteTheseDocuments' => 'Είστε σίγουροι ότι θέλετε να διαγράψετε αυτά τα έγγραφα;',
    'DocumentsDeleted' => 'Τα επιλεγμένα έγγραφα διαγράφηκαν.',
    'AllApprovers' => 'Όλοι οι υπεύθυνοι έγκρισης',
    'NotScheduled' => 'Δεν έχει προγραμματιστεί',
    'LastReviewDate' => 'Ημερομηνία Τελευταίας Αναθεώρησης',
    'DocumentAuditLogDownload' => 'Το έγγραφο "{$document_name}" λήφθηκε από τον χρήστη {$user}.',
    'Refresh' => 'Φρεσκάρω',
    'AuditTrailDateAndTime' => 'Ημερομηνία & Ώρα',
    ...
    'SearchAuditTrailPlaceholder' => 'Αναζήτηση διαδρομής ελέγχου',
    'NoAuditLogEntries' => 'Δεν υπάρχουν ακόμη καταχωρήσεις στο αρχείο καταγραφής ελέγχου',
    'NoAuditLogEntriesBody' => 'Η δραστηριότητα στα έγγραφα αυτής της σελίδας θα εμφανίζεται εδώ.',
    'NoAuditLogEntriesMatchFilters' => 'Δεν υπάρχουν καταχωρήσεις που να ταιριάζουν με την αναζήτησή σας',
    'NoAuditLogEntriesMatchFiltersBody' => 'Δοκιμάστε έναν διαφορετικό όρο αναζήτησης, εύρος ημερομηνιών ή φίλτρο.',
    'By' => 'από',
    'UnknownUser' => 'Άγνωστος χρήστης',
    'AllActivities' => 'Όλες οι δραστηριότητες',
    'DownloadSelected' => 'Λήψη επιλεγμένων',
    'NoDocumentsSelectedForDownload' => 'Δεν επιλέχθηκαν έγγραφα για λήψη.',
    'DocumentsDownloadTruncated' => 'Μόνο τα πρώτα {$limit} επιλεγμένα έγγραφα συμπεριλήφθηκαν στη λήψη. Επαναλάβετε την ενέργεια για να κατεβάσετε τα υπόλοιπα.',
    'NoDownloadableDocumentsSelected' => 'Κανένα από τα επιλεγμένα έγγραφα δεν διαθέτει αρχείο για λήψη.',
    'VersionHistory' => 'Ιστορικό εκδόσεων',
    'Current' => 'Τρέχον',
    'DeleteVersion' => 'Διαγραφή αυτής της έκδοσης',
    'ConfirmDeleteVersionQuestion' => 'Διαγραφή αυτής της έκδοσης αρχείου;',
    'ConfirmDeleteVersionConfirmBody' => 'Αυτό καταργεί μόνο αυτήν την ιστορική έκδοση αρχείου. Το έγγραφο και το τρέχον αρχείο του δεν επηρεάζονται.',
    'CannotDeleteCurrentDocumentVersion' => 'Η τρέχουσα έκδοση ενός εγγράφου δεν μπορεί να διαγραφεί με αυτόν τον τρόπο. Χρησιμοποιήστε την ενέργεια Διαγραφής στο ίδιο το έγγραφο.',
    'DocumentVersionDeleted' => 'Η έκδοση του εγγράφου διαγράφηκε.',
    'DeletedVersion' => 'Η έκδοση διαγράφηκε',
    'CouldNotLoadVersionHistory' => 'Δεν ήταν δυνατή η φόρτωση του ιστορικού εκδόσεων.',
    'DocumentsOverdueForReview' => 'Έγγραφα που έχουν εκπρόθεσμη αναθεώρηση',
    'DocumentsDueSoonForReview' => 'Έγγραφα που θα εξεταστούν σύντομα',
    'RequiresCustomizationExtra' => 'Απαιτείται η Επιπλέον Προσαρμογή.',
    'UnlockCustomizationLink' => 'Δείτε τι προσθέτει',
    'UnlockActivateCustomizationNote' => 'Το Customization Extra είναι εγκατεστημένο αλλά δεν είναι ενεργοποιημένο.',
    'UnlockActivateCustomizationLink' => 'Ενεργοποίησέ το',
    'ExceptionsOverdueForReview' => 'Εξαιρέσεις που έχουν εκπρόθεσμη αναθεώρηση',
    'ExceptionsDueSoonForReview' => 'Εξαιρέσεις που θα υποβληθούν σύντομα για έλεγχο',
    'PendingApproval' => 'Εκκρεμεί έγκριση',
    'AllExceptions' => 'Όλες οι εξαιρέσεις',
    'AllStates' => 'Όλες οι καταστάσεις',
    'DocumentDoesNotExist' => 'Το έγγραφο δεν υπάρχει',
    'SomeExceptionsNotDeleted' => 'Δεν ήταν δυνατή η διαγραφή ορισμένων από τις επιλεγμένες εξαιρέσεις. Ανανεώστε και δοκιμάστε ξανά.',
    'SomeDocumentsNotDeleted' => 'Δεν ήταν δυνατή η διαγραφή ορισμένων από τα επιλεγμένα έγγραφα. Παρακαλούμε ανανεώστε τη σελίδα και προσπαθήστε ξανά.',
    // Scheduled report "Run Now" success alerts (process_run_now_notification())
    'AutomatedNotificationOfRisksSent' => 'Έχει σταλεί η αυτοματοποιημένη ειδοποίηση για τους μη αναθεωρημένους και τους ληξιπρόθεσμους κινδύνους.',
    'AutomatedNotificationOfAuditsSent' => 'Η αυτόματη ειδοποίηση ελέγχων έχει σταλεί.',
    'AutomatedNotificationOfMitigationsSent' => 'Η αυτόματη ειδοποίηση για τους μετριασμούς έχει σταλεί.',
    'AutomatedNotificationOfUnmitigatedRisksSent' => 'Η αυτοματοποιημένη ειδοποίηση για τους μη μετριασμένους κινδύνους έχει σταλεί.',
    'AutomatedNotificationOfPolicyControlExceptionsSent' => 'Η αυτόματη ειδοποίηση για μη αναθεωρημένες και ληξιπρόθεσμες εξαιρέσεις πολιτικής και ελέγχου έχει σταλεί.',
    'AutomatedNotificationOfDocumentReviewsSent' => 'Η αυτόματη ειδοποίηση για τις αξιολογήσεις εγγράφων έχει σταλεί.',
    'NoWorkflowsDefinedYet' => 'Δεν έχουν οριστεί ακόμη ροές εργασίας. Κάντε κλικ στην επιλογή Νέα ροή εργασίας για να δημιουργήσετε μία.',
    'NoPermissionToViewDocumentation' => 'Δεν έχετε άδεια προβολής της τεκμηρίωσης',
    'AddDocumentType' => 'Προσθήκη τύπου εγγράφου',
    'BuiltIn' => 'Ενσωματωμένο',
    'TemplateGroups' => 'Ομάδες προτύπων',
    'ManageDocumentTypes' => 'Διαχείριση τύπων εγγράφων',
    'NeedANewCategoryManageDocumentTypes' => 'Χρειάζεστε μια νέα κατηγορία;',
    'ManageOptions' => 'Διαχείριση επιλογών',
    'AddCustomFieldSubtitle' => 'Προσθέστε προσαρμοσμένα πεδία για να καταγράψετε πληροφορίες που αφορούν συγκεκριμένα αυτήν την ομάδα πεδίων.',
    'NewField' => 'Νέο Πεδίο',
    'TemplateGroupsSectionSubtitle' => 'Δημιουργήστε πρόσθετες ομάδες προτύπων και αντιστοιχίστε τες σε επιχειρηματικές μονάδες.',
    'TemplateSectionSubtitle' => 'Επιλέξτε ποια πεδία εμφανίζονται σε αυτό το πρότυπο και με ποια σειρά.',
    'CustomFieldsSectionSubtitle' => 'Όλα τα προσαρμοσμένα πεδία έχουν οριστεί για αυτήν την ομάδα πεδίων, σε κάθε πρότυπο.',
    'CantDeleteSeededDocumentCategory' => 'Οι ενσωματωμένοι τύποι εγγράφων δεν μπορούν να διαγραφούν, επειδή άλλα μέρη του SimpleRisk αναφέρονται σε αυτούς με τα αρχικά τους ονόματα. Μπορείτε να προσθέσετε τους δικούς σας τύπους και να τους διαγράψετε ελεύθερα.',
    'FieldGroupSelectorSubtitle' => 'Επιλέξτε ποιας ομάδας πεδίων θέλετε να προσαρμόσετε τα πεδία και τα πρότυπα.',
    'CloneTemplateGroup' => 'Κλωνοποίηση αυτής της ομάδας προτύπων',
    'RequiredFieldCheckboxLabel' => 'Ορίστε αυτό το προσαρμοσμένο πεδίο ως υποχρεωτικό.',
    'AddField' => 'Προσθήκη πεδίου',
    'CoreFields' => 'Βασικά Πεδία',
    'SearchCoreFields' => 'Αναζήτηση βασικών πεδίων',
    'SearchCustomFields' => 'Αναζήτηση προσαρμοσμένων πεδίων',
    'AllCoreFieldsAddedToTab' => 'Όλα τα βασικά πεδία βρίσκονται σε αυτήν την καρτέλα.',
    'AllCustomFieldsAddedToTemplate' => 'Όλα τα προσαρμοσμένα πεδία βρίσκονται σε αυτό το πρότυπο.',
    'NoFieldsMatchSearchTerm' => 'Δεν υπάρχουν πεδία που να ταιριάζουν με το "{term}".',
    'NoCustomFieldsYet' => 'Δεν υπάρχουν ακόμη προσαρμοσμένα πεδία -- δημιουργήστε ένα παρακάτω για να το χρησιμοποιήσετε σε αυτό το πρότυπο.',
    'AddFieldsToPrefix' => 'Προσθήκη πεδίων σε',
    'AddFieldsHeading' => 'Προσθήκη πεδίων',
    'FieldPickerHint' => 'Κάνοντας κλικ σε ένα πεδίο, το προσθέτετε απευθείας στην παρακάτω διάταξη. Δεν υπάρχει τίποτα προς επιβεβαίωση.',
    'Done' => 'Έγινε',
    'FieldAddedToTab' => 'Προστέθηκε το {field} στο {tab}.',
    'FieldRemovedBackToList' => 'Αφαιρέθηκε το {field} -- είναι πίσω στη λίστα του.',
    'NowAddingToTab' => 'Τώρα προσθέτουμε στο {tab}.',
    'PickFieldToAdd' => 'Επιλέξτε ένα πεδίο από οποιαδήποτε στήλη για να το προσθέσετε.',
    'NewCustomField' => 'Νέο προσαρμοσμένο πεδίο',
