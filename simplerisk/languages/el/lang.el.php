...
$lang = array(
    ...
    'EmailTemplateSendingAssessment' => '
        Γεια σας <html><body>\\n, \\n <p> {$username} έχει aksed κινδυνεύετε να ολοκληρώσετε τα παρακάτω ερωτηματολόγιο αξιολόγησης:</p>\\n <p><a href="{$assessment_link}"> {$assessment_name} </a></p>\\n <p>This είναι ένα αυτοματοποιημένο μήνυμα και οι απαντήσεις θα πρέπει να αγνοηθεί ή rejected.</p>\\n </body></html>',
    ...
    'RiskIDNoEXitFailedToUpdate' => 'Το Αναγνωριστικό κινδύνου $risk_id δεν υπάρχει, γι \' αυτό είναι παρέλειψε να ενημερώσετε',
