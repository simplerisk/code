...
$lang = array(
    ...
    'SuccessUpdatingImpactName' => 'Η σύμβαση ονομασίας επιπτώσεων ενημερώθηκε με επιτυχία.',
    'FailUpdatingImpactName' => 'Αποτυχία ενημέρωσης του ονόματος αντίκτυπου.',
    'SuccessUpdatingLikelihoodName' => 'Η σύμβαση ονομασίας πιθανοτήτων ενημερώθηκε με επιτυχία.',
