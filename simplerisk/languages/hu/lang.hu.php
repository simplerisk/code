...
$lang = array(
    ...
    'EmailTemplateSendingAssessment' => '
        <html><body>\\n Hello, \\n <p> {$username} van, hogy töltse ki az alábbi kockázat értékelő kérdőív:</p>\\n aksed <p><a href="{$assessment_link}"> {$assessment_name} </a></p>\\n <p>This egy automatikus üzenet és válaszok figyelmen kívül hagyják vagy rejected.</p>\\n </body></html>',
    ...
    'RiskIDNoEXitFailedToUpdate' => 'Kockázat azonosítás $risk_id nem \' létezik, tehát ez megbukik-hoz korszerűsíteni',
