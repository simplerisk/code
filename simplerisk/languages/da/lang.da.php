...
$lang = array(
    ...
    'EmailTemplateSendingAssessment' => '
        <html><body> \\ n Hej, \\n <p> {$username} har aksed dig at udfylde følgende spørgeskema for risikovurdering:</p> \\ n <p><a href="{$assessment_link}"> {$assessment_name} </a></p> \\ n <p>This er en automatiseret besked og svar vil være ignoreret eller afslå. </p> \\ n </body></html>',
    ...
    'RiskIDNoEXitFailedToUpdate' => 'Risiko-id $risk_id eksisterer ikke, så det er mislykkedes at opdatere',
