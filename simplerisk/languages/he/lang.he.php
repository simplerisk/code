...
$lang = array(
    ...
    'Ordering' => 'זמנת',
    'EncryptionKeyNoExist' => 'קובץ מפתח Enryption אינו קיים. נא ליצור קשר עם admin.',
    ...
    'RiskSubmitSuccess' => 'סיכון{$subject}בהצלחה.',
    'Accepting' => 'קבלת...',
    'Rejecting' => 'דוחה',
    ...
    'WarnMySQLUploadSize' => 'אזהרה: מגבלת גודל הקובץ הנוכחית גדולה מ-MySQL מוגדרת להעלאות.  בדוק את ערכי הmax_allowed_packet והinnodb_log_file_size בקובץ. ncf שלך.',
    'Restore' => 'שחזור',
    '' => '',
);
