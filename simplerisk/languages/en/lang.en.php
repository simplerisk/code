...
$lang = array(
    ...
    'WorkflowHttpRequestDisallowedURL' => '{$action}: The URL {$url} resolves to a disallowed internal or reserved address.',
    ...
    'WorkflowsExtraDeactivateConfirm' => 'Deactivate the Workflows Extra? All workflow definitions, including the default system workflows, will be permanently deleted. Re-activating the Extra will recreate the default system workflows, but any customizations to them will be lost.',
    ...
    'NewUsernameAddedWithTemporaryPassword' => 'A new user with username "{$username}" was added successfully. Temporary password: {$password} (the user must change it at first login).',
    ...
    'EligibleTests' => 'Eligible tests',
    'InitiateSelected' => 'Initiate selected',
    'InitiateNAudits' => 'Initiate {n} audits',
    'TagsOptionalAppliedToSelection' => 'Tags (optional, applied to all)',
    'Initiate' => 'Initiate',
    'NoEligibleTestsFound' => 'No eligible tests found.',
    'Columns' => 'Columns',
    'ShowTestsWithAuditInProgress' => 'Show tests with an audit in progress',
    'NoMatchingOptions' => 'No matching options.',
    'TestDetails' => 'Test Details',
    'PeopleAndTeams' => 'People and Teams',
    'StatusAndTimeline' => 'Status and Timeline',
    'DataIntegrityTextEncoding' => 'Text Encoding',
    'DataIntegrityFileEncoding' => 'File Encoding',
    'DataIntegrity' => 'Data Integrity',
    'DataIntegrityDesc' => 'Review and repair records with corrupted or invalid data.',
    'ScanNow' => 'Scan Now',
    'BrokenValue' => 'Broken Value',
    'SuggestedFix' => 'Suggested Fix',
    'RepairSelected' => 'Repair Selected',
    'DataIntegrityAllCaughtUpTitle' => 'All caught up',
    'DataIntegrityAllCaughtUpBody' => 'No data integrity issues found.',
    'Repair' => 'Repair',
    'DataIntegrityTotalCount' => 'total',
    'DataIntegrityHealthCheckFailed' => '%d record(s) need repair. Visit the Data Integrity page under Settings to review them.',
    'DataIntegrityRecordLocation' => 'Record:',
    'DataIntegrityNotificationTitle' => 'Data integrity issues found',
    'DataIntegrityNotificationBody' => 'The Data Integrity scan found records that need repair.',
    'DataIntegrityShowingCapped' => 'Showing {n} of {total}.',
    ...
    'CouldNotLoadMappedFrameworks' => 'Could not load mapped frameworks.',
    'NoMappedFrameworksFound' => 'No mapped frameworks found.',
    'SearchMappedFrameworks' => 'Search frameworks or controls',
    'CommentNotAddedToAudit' => 'Your comment could not be added to the audit.',
    'AssetIdsRequired' => 'BAD REQUEST: asset_ids[] is required.',
    'TheDefaultBusinessUnitCannotBeDeleted' => 'The Default Business Unit cannot be deleted.',
    ...
    'OtherSessionsNotCleared' => 'Other active sessions could not be cleared and will remain signed in until they expire.',
    'BackupCannotResolveInstallDir' => 'Unable to resolve the SimpleRisk installation directory for the backup.',
    'BackupTargetChangedOrExists' => 'Refusing to write the backup into "{$dir}": the target changed unexpectedly or already exists.',
    'BackupDirectoryUnsafe' => 'Refusing to use the "{$location}" backup directory: it is a symlink or is owned by another account.',
    'DocumentAuditLogApprove' => 'Document "{$document_name}" was approved by {$user}.',
    'DocumentAuditLogUnapprove' => 'Document "{$document_name}" was unapproved by {$user}.',
    'NoApproveDocumentationPermission' => 'You have no permission to approve documents.',
    'DocumentApproved' => 'The document was approved.',
    'DocumentUnapproved' => 'The document was unapproved.',
    'DocumentsApproved' => 'The documents were approved.',
    'ApproveSelected' => 'Approve selected',
    'SearchDocumentsPlaceholder' => 'Search documents',
    'NoDocumentsYet' => 'No documents yet',
    'NoDocumentsYetBody' => 'Documents added to this category will show up here.',
    'NoDocumentsMatchFilters' => 'No documents match your search',
    'NoDocumentsMatchFiltersBody' => 'Try a different search term or switch categories.',
    'CouldNotLoadDocuments' => 'Could not load documents',
    'CouldNotLoadDocumentsBody' => 'Something went wrong while loading the Document Program grid.',
    'ApproveDocumentQuestion' => 'Approve this document?',
    'ApproveDocumentConfirmBody' => 'This sets "{name}" to Approved and calculates its next review date.',
    'UnapproveDocumentQuestion' => 'Unapprove this document?',
    'UnapproveDocumentConfirmBody' => 'This sends "{name}" back to In Review.',
    ...
    'ExceptionsApproved' => 'The exceptions were approved.',
    'FrameworkControl' => 'Framework / Control',
    'NoExceptionsYet' => 'No exceptions yet',
    'NoExceptionsYetBody' => 'Exceptions you add will show up here.',
    'NoExceptionsMatchFilters' => 'No exceptions match your search',
    'NoExceptionsMatchFiltersBody' => 'Try a different search term or clear your search.',
    'CouldNotLoadExceptions' => 'Could not load exceptions',
    'CouldNotLoadExceptionsBody' => 'Something went wrong while loading the Define Exceptions grid.',
    'ApproveExceptionQuestion' => 'Approve this exception?',
    'ApproveExceptionConfirmBody' => 'This sets "{name}" to Approved.',
    'UnapproveExceptionQuestion' => 'Unapprove this exception?',
    'UnapproveExceptionConfirmBody' => 'This sends "{name}" back to Pending.',
    'ApproveSelectedExceptionsQuestion' => 'Approve {n} selected exceptions?',
    'ApproveSelectedExceptionsConfirmBody' => 'This approves {n} selected exceptions.',
    'SearchExceptionsPlaceholder' => 'Search exceptions...',
    'DeleteSelected' => 'Delete selected',
    'ExceptionsDeleted' => 'The selected exceptions were deleted.',
    'GovernanceReviewDueEmailSubject' => 'Review due: {$name}',
    'GovernanceReviewDueEmailBody' => '{$name} is due for review.',
    'DocumentDetails' => 'Document details',
    'WhereItApplies' => 'Where it applies',
    'WhoIsInvolved' => "Who's involved",
    'ReviewCadence' => 'Review cadence',
    'ExceptionDetails' => 'Exception details',
    'DescriptionJustification' => 'Description & justification',
    'ChooseAControl' => 'Choose a control',
    'CantDeleteDocumentCategoryInUse' => 'Cannot delete this document type, because there are documents that are currently filed under it.',
    'ExceptionDoesNotExist' => 'Document Exception Does Not Exist',
    'DocumentAuditTrailReport' => 'Document Audit Trail Report',
    'PastWeek' => 'Past Week',
    'PastMonth' => 'Past Month',
    'PastQuarter' => 'Past Quarter',
    'Past6Months' => 'Past 6 Months',
    'PastYear' => 'Past Year',
    'CantRenameSeededDocumentCategory' => 'The built-in document types cannot be renamed, because other parts of SimpleRisk refer to them by their original names. You can add your own types and rename those freely.',
    'DocumentsApprovedTruncated' => 'Only the first {$limit} selected documents were approved. Please repeat the action to approve the rest.',
    'ExceptionsApprovedTruncated' => 'Only the first {$limit} selected exceptions were approved. Please repeat the action to approve the rest.',
    'AreYouSureYouWantToDeleteTheseDocuments' => 'Are you sure you want to delete these documents?',
    'DocumentsDeleted' => 'The selected documents were deleted.',
    'AllApprovers' => 'All approvers',
    'NotScheduled' => 'Not scheduled',
    'LastReviewDate' => 'Last Review Date',
    'DocumentAuditLogDownload' => 'Document "{$document_name}" was downloaded by {$user}.',
    'Refresh' => 'Refresh',
    'AuditTrailDateAndTime' => 'Date & Time',
    'Activity' => 'Activity',
    'Updated' => 'Updated',
    'Deleted' => 'Deleted',
    ...
    'AllUsers' => 'All users',
    'SearchAuditTrailPlaceholder' => 'Search audit trail',
    'NoAuditLogEntries' => 'No audit log entries yet',
    'NoAuditLogEntriesBody' => 'Activity on this page\'s documents will show up here.',
    'NoAuditLogEntriesMatchFilters' => 'No entries match your search',
    'NoAuditLogEntriesMatchFiltersBody' => 'Try a different search term, date range, or filter.',
    'By' => 'by',
    'UnknownUser' => 'Unknown user',
    'AllActivities' => 'All activities',
    'DownloadSelected' => 'Download selected',
    'NoDocumentsSelectedForDownload' => 'No documents were selected for download.',
    ...
    'NoDownloadableDocumentsSelected' => 'None of the selected documents have a file to download.',
    'VersionHistory' => 'Version History',
    'Current' => 'Current',
    'DeleteVersion' => 'Delete this version',
    'ConfirmDeleteVersionQuestion' => 'Delete this file version?',
    'ConfirmDeleteVersionConfirmBody' => 'This removes only this historical file version. The document and its current file are not affected.',
    'CannotDeleteCurrentDocumentVersion' => 'The current version of a document can\'t be deleted this way. Use the Delete action on the document itself instead.',
    'DocumentVersionDeleted' => 'The document version was deleted.',
    'DeletedVersion' => 'Version deleted',
    'CouldNotLoadVersionHistory' => 'Could not load version history.',
    'DocumentsOverdueForReview' => 'Documents Overdue for Review',
    'DocumentsDueSoonForReview' => 'Documents Due Soon for Review',
    'RequiresCustomizationExtra' => 'Requires the Customization Extra.',
    'UnlockCustomizationLink' => 'See what it adds',
    'UnlockActivateCustomizationNote' => 'The Customization Extra is installed but not turned on.',
    'UnlockActivateCustomizationLink' => 'Turn it on',
    'ExceptionsOverdueForReview' => 'Exceptions Overdue for Review',
    'ExceptionsDueSoonForReview' => 'Exceptions Due Soon for Review',
    'PendingApproval' => 'Pending Approval',
    'AllExceptions' => 'All Exceptions',
    'AllStates' => 'All states',
    'DocumentDoesNotExist' => 'Document Does Not Exist',
    'SomeExceptionsNotDeleted' => 'Some of the selected exceptions could not be deleted. Please refresh and try again.',
    'SomeDocumentsNotDeleted' => 'Some of the selected documents could not be deleted. Please refresh and try again.',
    // Scheduled report "Run Now" success alerts (process_run_now_notification())
    'AutomatedNotificationOfRisksSent' => 'The automated notification of unreviewed and past due risks has been sent.',
    'AutomatedNotificationOfAuditsSent' => 'The automated notification of audits has been sent.',
    'AutomatedNotificationOfMitigationsSent' => 'The automated notification of mitigations has been sent.',
    'AutomatedNotificationOfUnmitigatedRisksSent' => 'The automated notification of unmitigated risks has been sent.',
    'AutomatedNotificationOfPolicyControlExceptionsSent' => 'The automated notification of unreviewed and past due policy and control exceptions has been sent.',
    'AutomatedNotificationOfDocumentReviewsSent' => 'The automated notification of document reviews has been sent.',
    'NoWorkflowsDefinedYet' => 'No workflows defined yet. Click New Workflow to create one.',
    'NoPermissionToViewDocumentation' => 'You don\'t have permission to view Documentation',
    'AddDocumentType' => 'Add document type',
    'BuiltIn' => 'Built-in',
    'TemplateGroups' => 'Template Groups',
    'ManageDocumentTypes' => 'Manage document types',
    'NeedANewCategoryManageDocumentTypes' => 'Need a new category?',
    'ManageOptions' => 'Manage Options',
    'AddCustomFieldSubtitle' => 'Add custom fields to capture information specific to this field group.',
    'NewField' => 'New Field',
    'TemplateGroupsSectionSubtitle' => 'Create additional template groups and assign them to business units.',
    'TemplateSectionSubtitle' => 'Choose which fields appear in this template, and in what order.',
    'CustomFieldsSectionSubtitle' => 'All custom fields defined for this field group, across every template.',
    'CantDeleteSeededDocumentCategory' => 'The built-in document types cannot be deleted, because other parts of SimpleRisk refer to them by their original names. You can add your own types and delete those freely.',
    'FieldGroupSelectorSubtitle' => 'Choose which field group\'s fields and templates you want to customize.',
    'CloneTemplateGroup' => 'Clone this template group',
    'RequiredFieldCheckboxLabel' => 'Make this custom field required.',
    'AddField' => 'Add Field',
    'CoreFields' => 'Core Fields',
    'SearchCoreFields' => 'Search core fields',
    'SearchCustomFields' => 'Search custom fields',
    'AllCoreFieldsAddedToTab' => 'All core fields are on this tab.',
    'AllCustomFieldsAddedToTemplate' => 'All custom fields are on this template.',
    'NoFieldsMatchSearchTerm' => 'No fields match "{term}".',
    'NoCustomFieldsYet' => 'No custom fields yet -- create one below to use it on this template.',
    'AddFieldsToPrefix' => 'Add fields to',
    'AddFieldsHeading' => 'Add fields',
    'FieldPickerHint' => 'Clicking a field adds it straight to the layout below. Nothing to confirm.',
    'Done' => 'Done',
    'FieldAddedToTab' => 'Added {field} to {tab}.',
    'FieldRemovedBackToList' => 'Removed {field} -- it is back in its list.',
    'NowAddingToTab' => 'Now adding to {tab}.',
    'PickFieldToAdd' => 'Pick a field from either column to add it.',
