...
$lang = array(
    ...
    'NoPermissionForThisAction'=>'您没有执行此操作的权限。',
    ...
    'WorkflowHttpRequestDisallowedURL' => '{$action}：URL {$url} 解析到不允许的内部地址或保留地址。',
    ...
    'WorkflowsExtraDeactivateConfirm' => '停用“工作流扩展”？所有工作流定义（包括默认系统工作流）都将被永久删除。重新激活该扩展将重新创建默认系统工作流，但所有自定义设置都将丢失。',
    ...
    'NewUsernameAddedWithTemporaryPassword' => '已成功添加用户名“{$username}”的新用户。临时密码： {$password} （用户首次登录时必须更改密码）。',
    'YouDontHavePermission' => '您没有权限。',
    // Initiate Audits bulk-select
    'InitiatedTestsBulk' => '已启动 $count 测试。',
    // Merged Audits page (replaces Active Audits + Past Audits menu items)
    'Audits' => '审计',
    'ManageAudits' => '管理审计',
    'ViewAudits' => '查看审计',
    // Redesigned, flat Initiate Audits page
    'EligibleTests' => '符合条件的测试',
    'InitiateSelected' => '启动选定',
    'InitiateNAudits' => '启动 {n} 审计',
    'TagsOptionalAppliedToSelection' => '标签（可选，应用于所有标签）',
    'Initiate' => '发起',
    'NoEligibleTestsFound' => '未找到符合条件的检测。',
    'Columns' => '列',
    'ShowTestsWithAuditInProgress' => '显示正在进行的审计测试',
    'NoMatchingOptions' => '没有匹配项。',
    'TestDetails' => '测试详情',
    'PeopleAndTeams' => '人员和团队',
    'StatusAndTimeline' => '状态和时间表',
    'DataIntegrityTextEncoding' => '文本编码',
    'DataIntegrityFileEncoding' => '文件编码',
    'DataIntegrity' => '数据完整性',
    'DataIntegrityDesc' => '审核并修复数据损坏或无效的记录。',
    'ScanNow' => '立即扫描',
    'BrokenValue' => '损坏的值',
    'SuggestedFix' => '建议的修复方案',
    'RepairSelected' => '修复选定项',
    'DataIntegrityAllCaughtUpTitle' => '全部处理完毕',
    'DataIntegrityAllCaughtUpBody' => '未发现数据完整性问题。',
    'Repair' => '修复',
    'DataIntegrityTotalCount' => '总计',
    'DataIntegrityHealthCheckFailed' => '%d 条记录需要修复。请访问“设置”下的“数据完整性”页面进行查看。',
    'DataIntegrityRecordLocation' => '记录：',
    'DataIntegrityNotificationTitle' => '发现数据完整性问题',
    'DataIntegrityNotificationBody' => '数据完整性扫描发现了一些需要修复的记录。',
    'DataIntegrityShowingCapped' => '显示 {total} 中的 {n}。',
    ...
    'CouldNotLoadMappedFrameworks' => '无法加载映射框架。',
    'NoMappedFrameworksFound' => '未找到已映射的框架。',
    'SearchMappedFrameworks' => '搜索框架或控件',
    'CommentNotAddedToAudit' => '您的评论无法添加到审核中。',
    'AssetIdsRequired' => '错误请求：缺少 asset_ids[] 参数。',
    'TheDefaultBusinessUnitCannotBeDeleted' => '默认业务单元无法删除。',
    ...
    'OtherSessionsNotCleared' => '其他正在进行的会话无法清除，将保持登录状态直至过期。',
    'BackupCannotResolveInstallDir' => '无法解析用于备份的 SimpleRisk 安装目录。',
    'BackupTargetChangedOrExists' => '拒绝将备份写入“{$dir}”：目标已意外更改或已存在。',
    'BackupDirectoryUnsafe' => '拒绝使用“{$location}”备份目录：它是符号链接或属于其他帐户。',
    'DocumentAuditLogApprove' => '文件“{$document_name}”已由 {$user}批准。',
    'DocumentAuditLogUnapprove' => '文件“{$document_name}”未经 {$user}批准。',
    'NoApproveDocumentationPermission' => '您没有审批文件的权限。',
    'DocumentApproved' => '文件已获批准。',
    'DocumentUnapproved' => '该文件未经批准。',
    'DocumentsApproved' => '文件已获批准。',
    'ApproveSelected' => '批准所选',
    'SearchDocumentsPlaceholder' => '搜索文档',
    'NoDocumentsYet' => '暂无文件',
    'NoDocumentsYetBody' => '添加到此类别中的文档将显示在此处。',
    'NoDocumentsMatchFilters' => '没有找到符合您搜索条件的文档',
    'NoDocumentsMatchFiltersBody' => '尝试不同的搜索词或切换类别。',
    'CouldNotLoadDocuments' => '无法加载文档',
    'CouldNotLoadDocumentsBody' => '加载文档程序网格时出错。',
    'ApproveDocumentQuestion' => '批准这份文件吗？',
    'ApproveDocumentConfirmBody' => '这会将“{name}”设置为“已批准”，并计算其下次审核日期。',
    'UnapproveDocumentQuestion' => '取消批准此文档？',
    'UnapproveDocumentConfirmBody' => '这会将“{name}”返回到“待审核”状态。',
    'ApproveSelectedDocumentsQuestion' => '批准 {n} 选定的文档？',
    'ApproveSelectedDocumentsConfirmBody' => '此功能会批准 {n} 个选定的文档，并计算每个文档的下次审核日期。',
    'AddCategory' => '添加类别',
    'ExceptionsApproved' => '这些例外情况已获批准。',
    'FrameworkControl' => '框架/控制',
    'NoExceptionsYet' => '目前尚无例外。',
    'NoExceptionsYetBody' => '您添加的例外情况将显示在此处。',
    'NoExceptionsMatchFilters' => '没有例外情况符合您的搜索条件',
    'NoExceptionsMatchFiltersBody' => '请尝试使用不同的搜索词或清除搜索条件。',
    'CouldNotLoadExceptions' => '无法加载异常信息。',
    'CouldNotLoadExceptionsBody' => '加载“定义异常”网格时出错。',
    'ApproveExceptionQuestion' => '批准这项例外情况？',
    'ApproveExceptionConfirmBody' => '这会将“{name}”设置为“已批准”。',
    'UnapproveExceptionQuestion' => '否决此例外？',
    'UnapproveExceptionConfirmBody' => '这会将“{name}”返回到 Pending。',
    'ApproveSelectedExceptionsQuestion' => '批准 {n} 项选定的例外情况？',
    'ApproveSelectedExceptionsConfirmBody' => '这将批准 {n} 个选定的例外情况。',
    'SearchExceptionsPlaceholder' => '搜索例外情况……',
    'DeleteSelected' => '删除所选内容',
    'ExceptionsDeleted' => '已删除选定的例外情况。',
    'GovernanceReviewDueEmailSubject' => '审核截止日期： {$name}',
    'GovernanceReviewDueEmailBody' => '{$name} 需要审核。',
    ...
    'ChooseAControl' => '选择一个控件',
    'CantDeleteDocumentCategoryInUse' => '无法删除此文档类型，因为目前已有文档归档于此类型下。',
    'ExceptionDoesNotExist' => '文档异常不存在',
    'DocumentAuditTrailReport' => '文件审计跟踪报告',
    'PastWeek' => '过去一周',
    'PastMonth' => '上个月',
    'PastQuarter' => '上个季度',
    'Past6Months' => '过去6个月',
    'PastYear' => '过去一年',
    'CantRenameSeededDocumentCategory' => '内置文档类型无法重命名，因为 SimpleRisk 的其他部分仍然使用它们的原始名称。您可以添加自己的文档类型并自由重命名。',
    'DocumentsApprovedTruncated' => '仅批准了前 {$limit} 个选定文档。请重复此操作以批准其余文档。',
    'ExceptionsApprovedTruncated' => '仅批准了前 {$limit} 个选定的例外情况。请重复此操作以批准其余例外情况。',
    'AreYouSureYouWantToDeleteTheseDocuments' => '您确定要删除这些文档吗？',
    'DocumentsDeleted' => '选定的文件已被删除。',
    'AllApprovers' => '所有审批人',
    'NotScheduled' => '未安排',
    'LastReviewDate' => '上次审核日期',
    'DocumentAuditLogDownload' => '文档“{$document_name}”由 {$user}下载。',
    'Refresh' => '刷新',
    'AuditTrailDateAndTime' => '日期和时间',
    'Activity' => '活动',
    'Updated' => '更新',
    'Deleted' => '已删除',
    'Downloaded' => '下载',
    ...
    'AllDocuments' => '所有文件',
    'AllUsers' => '所有用户',
    'SearchAuditTrailPlaceholder' => '搜索审计跟踪',
    'NoAuditLogEntries' => '暂无审计日志条目',
    'NoAuditLogEntriesBody' => '此页面上文档的活动将显示在此处。',
    'NoAuditLogEntriesMatchFilters' => '没有找到符合您搜索条件的结果。',
    'NoAuditLogEntriesMatchFiltersBody' => '尝试不同的搜索词、日期范围或筛选条件。',
    'By' => '经过',
    'UnknownUser' => '未知用户',
    'AllActivities' => '所有活动',
    'DownloadSelected' => '下载所选内容',
    'NoDocumentsSelectedForDownload' => '未选择任何文件进行下载。',
    'DocumentsDownloadTruncated' => '下载仅包含前 {$limit} 个选定文档。请重复此操作以下载其余文档。',
    'NoDownloadableDocumentsSelected' => '所选文档均无可供下载的文件。',
    'VersionHistory' => '版本历史记录',
    'Current' => '当前的',
    'DeleteVersion' => '删除此版本',
    'ConfirmDeleteVersionQuestion' => '删除此文件版本？',
    'ConfirmDeleteVersionConfirmBody' => '此操作仅删除此历史文件版本。文档及其当前文件不受影响。',
    'CannotDeleteCurrentDocumentVersion' => '无法通过这种方式删除文档的当前版本。请改用文档本身的“删除”操作。',
    'DocumentVersionDeleted' => '文档版本已被删除。',
    'DeletedVersion' => '版本已删除',
    'CouldNotLoadVersionHistory' => '无法加载版本历史记录。',
    'DocumentsOverdueForReview' => '文件逾期未审核',
    'DocumentsDueSoonForReview' => '即将提交审核的文件',
    'RequiresCustomizationExtra' => '需要额外定制服务。',
    'UnlockCustomizationLink' => '看看它能带来什么好处',
    'UnlockActivateCustomizationNote' => '自定义附加组件已安装，但未启用。',
    'UnlockActivateCustomizationLink' => '打开它',
    'ExceptionsOverdueForReview' => '逾期未审核的例外情况',
    'ExceptionsDueSoonForReview' => '即将进行审核的例外情况',
    'PendingApproval' => '待批准',
    'AllExceptions' => '所有例外',
    'AllStates' => '所有州',
    'DocumentDoesNotExist' => '文档不存在',
    'SomeExceptionsNotDeleted' => '部分选定的例外情况无法删除。请刷新页面后重试。',
    'SomeDocumentsNotDeleted' => '部分选定文档无法删除。请刷新页面后重试。',
    // Scheduled report "Run Now" success alerts (process_run_now_notification())
    'AutomatedNotificationOfRisksSent' => '未审核和逾期风险的自动通知已发送。',
    'AutomatedNotificationOfAuditsSent' => '审计自动通知已发送。',
    'AutomatedNotificationOfMitigationsSent' => '缓解措施的自动通知已发送。',
    'AutomatedNotificationOfUnmitigatedRisksSent' => '已发出未缓解风险的自动通知。',
    'AutomatedNotificationOfPolicyControlExceptionsSent' => '系统已自动发送未审核和逾期政策及控制例外情况的通知。',
    'AutomatedNotificationOfDocumentReviewsSent' => '文件审核的自动通知已发送。',
    'NoWorkflowsDefinedYet' => '尚未定义任何工作流程。单击“新建工作流程”创建一个。',
    'NoPermissionToViewDocumentation' => '您没有查看文档的权限',
    'AddDocumentType' => '添加文档类型',
    'BuiltIn' => '内置',
    'TemplateGroups' => '模板组',
    'ManageDocumentTypes' => '管理文档类型',
    'NeedANewCategoryManageDocumentTypes' => '需要新增类别吗？',
    'ManageOptions' => '管理选项',
    'AddCustomFieldSubtitle' => '添加自定义字段以捕获此字段组的特定信息。',
    'NewField' => '新领域',
    'TemplateGroupsSectionSubtitle' => '创建更多模板组并将其分配给业务部门。',
    'TemplateSectionSubtitle' => '选择此模板中要显示的字段及其顺序。',
    'CustomFieldsSectionSubtitle' => '此字段组在所有模板中定义的所有自定义字段。',
    'CantDeleteSeededDocumentCategory' => '内置文档类型无法删除，因为 SimpleRisk 的其他部分仍然使用它们的原始名称引用它们。您可以添加自己的文档类型，也可以随意删除它们。',
    'FieldGroupSelectorSubtitle' => '选择要自定义的字段组的字段和模板。',
    'CloneTemplateGroup' => '克隆此模板组',
    'RequiredFieldCheckboxLabel' => '将此自定义字段设为必填项。',
    'AddField' => '添加字段',
    'CoreFields' => '核心领域',
    'SearchCoreFields' => '搜索核心字段',
    'SearchCustomFields' => '搜索自定义字段',
    'AllCoreFieldsAddedToTab' => '所有核心字段都在此标签页中。',
    'AllCustomFieldsAddedToTemplate' => '此模板包含所有自定义字段。',
    'NoFieldsMatchSearchTerm' => '没有字段与“{term}”匹配。',
    'NoCustomFieldsYet' => '尚未创建自定义字段——请在下方创建一个，以便在该模板中使用它。',
    'AddFieldsToPrefix' => '添加字段',
    'AddFieldsHeading' => '添加字段',
    'FieldPickerHint' => '点击字段即可将其直接添加到下方布局中。无需确认。',
    'Done' => '完毕',
    'FieldAddedToTab' => '已将 {field} 添加到 {tab}。',
    'FieldRemovedBackToList' => '已移除 {field} -- 它已重新添加到列表中。',
    'NowAddingToTab' => '现在添加到 {tab}。',
    'PickFieldToAdd' => '从任一列中选择一个字段进行添加。',
