...
$lang = array(
    ...
    'ActivatingSCFMessage' => '安装安全控制框架 (SCF) 框架。这可能需要几分钟才能完成。',
    'DeactivatingSCFMessage' => '卸载安全控制框架 (SCF) 框架。',
    'UpdatingSCFMessage' => '更新安全控制框架 (SCF) 框架。这可能需要几分钟才能完成。',
    'Processing' => '处理。。。',
    ...
    'ThreatMapping' => '威胁测绘',
    'jQueryDeliveryMethod' => 'jQuery 传递方法',
    'AuditLog_DocumentUpdates' => '文档“{$document_name}”(ID: {$document_id}) 已由“{$user_name}”更新。变化： {$changes}。',
    'DocumentStatus' => '文件状态',
    ...
    'ExistingRisk' => '存在的风险',
    'AvailableRisks' => '可用风险',
    'WouldYouLikeToAssociateThisFailedTestResultWithARisk' => '您想将这个失败的测试结果与风险相关联吗？',
    ...
    'RemoteSAMLRolePlaceholder' => '选择远程角色或添加新角色',
    'RemoteSAMLTeamPlaceholder' => '选择一个远程团队或添加一个新团队',
    'MappingSuccessfullyUpdated' => '地图更新成功！',
    'BusinessUnit' => '事业部',
    'UserUpdatedAuditLog' => '用户“{$username}”已由“{$updater}”更新。变化： {$changes}。',
    'UserUpdatedFromidPDataAuditLog' => '使用从 idP 接收到的新数据更新了用户“{$username}”。变化： {$changes}。',
    'UpdateUserWithDataFromTheIdP' => '使用来自 idP 的数据更新用户',
    'LDAPRoleMapping' => 'LDAP 角色映射',
    'LDAPTeamMapping' => 'LDAP 组映射',
    'RemoteLDAPRolePlaceholder' => '选择远程角色或添加新角色',
    'RemoteLDAPTeamPlaceholder' => '选择一个远程组或添加一个新组',
    'MapTeamToLDAPGroup' => '将团队映射到 LDAP 组',
    'RemoteMappingDuplicationError' => '远程映射包含重复项',
    'LDAPFailedToRefreshGroups' => '刷新 LDAP 组失败',
    'ManageStoredRemoteItems' => '管理存储的远程项目',
    'SAMLTeam' => 'SAML团队',
    'SAMLRole' => 'SAML 角色',
    'LDAPGroup' => 'LDAP组',
    'LDAPUserFilterInstructions' => '请确保您的过滤器正在使用 %username% 变量。这将用于在服务器上查找用户时将用户名包含在过滤器中。将过滤器保存为空会将其设置为其默认值。',
    'LogoutFromRemoteSessions' => '注销终止 SimpleRisk 会话并将用户从 SAML 身份提供者 (IdP) 中注销',
    'SAMLLogoutSuccessful' => '您已从 SAML 会话中注销。',
    'SAMLLogoutFailed' => '我们无法让您退出所有会话。要完全确定您已注销，您需要关闭网络浏览器。',
    'SpecifiedNameAlreadyInUse' => '指定的名称已被使用。',
    'MaximumRiskSubjectLength' => '最大风险主题长度',
    'RiskSubjectTruncated' => '风险主题太长，被截断为 {$limit} 字符。',
    'BootstrapDeliveryMethod' => '引导交付方式',
    'TestAuditDoesNotExist' => '测试审计不存在',
    'QuestionnaireEmailTemplate' => '调查问卷电子邮件模板',
    'QuestionnaireCompletionEmailTemplate' => '问卷完成电子邮件模板',
    'QuestionnaireResultRejectEmailTemplate' => '调查问卷结果拒绝电子邮件模板',
    ...
    'NoGroup' => '没有组',
    'InvalidGroups' => '无效组！',
    'OrderUpdatedSuccessfully' => '订单更新成功。',
    ...
    'ThreatCatalogDropdownPlaceholder' => '选择威胁映射或开始键入以进行搜索',
    'UserDropdownPlaceholder' => '选择一个用户或开始输入以进行搜索',
    ...
    'AuditLog_DocumentCreate' => '名为“{$document_name}”的新文档由用户“{$user_name}”创建。',
    'UpdatedBy'=>'更新者',
    ...
    'IncidentManagementNotification_SectionHeader_details_changed' => '通知详细信息更改',
    ...
    'IncidentManagementNotification_SectionHeader_all_recovery_steps_completed' => '通知所有恢复步骤已完成',
    ...
    'IncidentManagementNotification_SectionHeader_lesson_learned_added' => '添加了经验教训通知',
    ...
    'IncidentManagementNotification_EmailSubject_all_recovery_steps_completed' => '所有事件恢复步骤已完成',
    'IncidentManagementNotification_EmailSubject_evidence_attached' => '事件中添加了新的证据',
    'IncidentManagementNotification_EmailSubject_notes_added' => '添加到事件的新注释',
    'IncidentManagementNotification_EmailSubject_lesson_learned_added' => '事件中吸取的新教训',
    'NotSpecified' => '未指定',
    ...
    'InvalidUsernameOrPasswordCaseSensitive' => '无效的用户名或密码。 （注意：用户名和密码均区分大小写。）',
    ...
    'DuoToopherRemoved' => 'SimpleRisk 不再直接支持 Duo。相反，我们已迁移到通用 TOTP 身份验证器。请在下面设置您的新身份验证器。',
    'ProtectYourSimpleRiskAccount' => '保护您的 SimpleRisk 账户',
    ...
    'YourSimpleRiskAccountIsProtected' => '您的 SimpleRisk 账户受 MFA 保护。',
    ...
    'EnablingSelectedSCFMessage' => '启用选定的安全控制框架 (SCF) 框架。这可能需要几秒钟才能完成。',
    'DisablingSelectedSCFMessage' => '禁用选定的安全控制框架 (SCF) 框架。',
    'MappedAssets' => '映射资产',
    'AddControl' => '添加控件',
    'CurrentMaturity' => '当前到期日',
    'AddDocument' => '添加文件',
    'EditDocument' => '编辑文档',
    'EncodingIssueCountUpdated' => '类型“{$type}”的编码问题计数已更新： {$old_count} -> {$count}。',
    'EncodingIssueCleanedUp' => '类型“{$type}”的编码问题已清除。',
    'RejectedRisk' => '拒绝风险',
    'DeletedRisk' => '删除的风险',
    'ClosedRisk' => '关闭风险',
    'AllClosedRisksFromQuestionnaires' => '问卷调查中的所有已关闭风险',
    'AllDeletedRisksFromQuestionnaires' => '问卷中所有已删除的风险',
    ...
    'ResendAssessment' => '每 {$day} 天安排并发送一次此评估。',
    ...
    'NoPermissionForAddQuestionnaireTemplates' => '您无权添加调查问卷模板',
    'NoPermissionForEditQuestionnaireTemplates' => '您无权编辑调查问卷模板',
    'NoPermissionForDeleteQuestionnaireTemplates' => '您无权删除调查问卷模板',
    'NoPermissionForAddQuestionnaires' => '您无权添加调查问卷',
    ...
    'GenericDeleteItemConfirmation' => '您确实要删除所选项目吗？',
    'ConfirmDeletePendingRisk' => '您确实要删除所选项目吗？',
    'Display' => '展示',
    ...
    'QuestionnaireResultNotApprovedAuditLog' => '问卷“{$questionnaire_name}”（发送给“{$date}”上的联系人“{$contact_name}”）的结果被用户“{$user_name}”标记为未批准。',
