...
$lang = array(
    ...
    'QuestionnaireResultApprovedAuditLog' => '问卷"${questionnaire_name}" 已通过用户"${user_name}".',
    'QuestionnaireResultRejectedAuditLog' => '问卷"${questionnaire_name}" 被拒绝，并送回联系"${contact_name}"供用户重新评估"${user_name}"带注释"{$reject_comment}".',
