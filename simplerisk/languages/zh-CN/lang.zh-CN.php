...
$lang = array(
    ...
    'SubQuestions' => '子问题',
    'Ordering' => '订购',
    'EncryptionKeyNoExist' => 'Enryption 密钥文件不存在。请与管理员联系。',
    ...
    'RiskSubmitSuccess' => '风险{$subject}成功.',
    'Accepting' => '接受。。。',
    'Rejecting' => '拒绝。。。',
    ...
    'WarnMySQLUploadSize' => '警告: 当前文件大小限制大于为上载配置的 MySQL。 检查我的. ncf 文件中的 max_allowed_packet 和 innodb_log_file_size 值。',
    'Restore' => '恢复',
    '' => '',
);
