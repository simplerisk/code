...
$lang = array(
    ...
    'ActivatingSCFMessage' => '安装安全控制框架 (SCF)。这可能需要几分钟才能完成。',
    'DeactivatingSCFMessage' => '卸载安全控制框架 (SCF) 框架。',
    'UpdatingSCFMessage' => '更新安全控制框架 (SCF)。这可能需要几分钟才能完成。',
    'Processing' => '处理。。。',
    ...
    'EnableAIAssistanceForRiskData' => '为风险数据启用 AI 辅助（数据将使用您的 API 密钥发送至 Anthropic）',
    ...
    'Documentation' => '文档',
    'EnableAIAssistanceForDocumentData' => '为文档数据启用 AI 辅助（数据将使用您的 API 密钥发送至 Anthropic）',
