...
class BaseWidget {
   ...
   * ```
    ...
    deserialize(w) {
        ...
        this.widgetItem = w;
        if (!(w === null || w === void 0 ? void 0 : w.props))
            return;
        if (this._compRef) {
    ...
    if (add) {
        ...
        if (isGrid) {
            ...
            if (type) {
                ...
                const createComp = () => {
                    var _a;
                    const compRef = (_a = gridItem.container) === null || _a === void 0 ? void 0 : _a.createComponent(type);
                    const childWidget = compRef === null || compRef === void 0 ? void 0 : compRef.instance;
                ...
                if (lazyLoad) {
                    if (!n.visibleObservable) {
                        n.visibleObservable = new IntersectionObserver(([entry]) => {
                            ...
                            if (entry.isIntersecting) {
                                ...
                                (_b = n.grid) === null || _b === void 0 ? void 0 : _b.refreshDragHandles(gridItem.el);
                            }
                        });
                    ...
                    // Re-scan for any custom drag-handle elements now that the Angular component
                    // has been rendered inside the item content.
                    (_f = n.grid) === null || _f === void 0 ? void 0 : _f.refreshDragHandles(gridItem.el);
                }
            }
            return gridItem.el;
        }
        ...
        //
        if (isGrid) {
            const grid = (_g = n.el) === null || _g === void 0 ? void 0 : _g._gridComp;
            ...
            const gridItem = (_h = n.el) === null || _h === void 0 ? void 0 : _h._gridItemComp;
...
function gsSaveAdditionalNgInfo(n, w) {
    ...
    if (gridItem) {
        const props = (_b = gridItem.childWidget) === null || _b === void 0 ? void 0 : _b.serialize();
        if (props) {
            w.props = props;
        }
        return;
...
function gsUpdateNgComponents(n) {
    ...
    const w = n;
    const gridItem = (_a = n.el) === null || _a === void 0 ? void 0 : _a._gridItemComp;
    if ((gridItem === null || gridItem === void 0 ? void 0 : gridItem.childWidget) && w.props)
