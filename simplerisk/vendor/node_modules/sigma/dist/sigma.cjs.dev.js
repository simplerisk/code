...
var index = require('./index-f81ac934.cjs.dev.js');
var inherits = require('./inherits-3d03d999.cjs.dev.js');
var types_dist_sigmaTypes = require('../types/dist/sigma-types.cjs.dev.js');
var normalization = require('./normalization-d0c5ff9f.cjs.dev.js');
...
var Camera = /*#__PURE__*/function (_TypedEventEmitter) {
  ...
  function Camera() {
    ...
    index._defineProperty(inherits._assertThisInitialized(_this), "enabledZooming", true);
    index._defineProperty(inherits._assertThisInitialized(_this), "enabledPanning", true);
    index._defineProperty(inherits._assertThisInitialized(_this), "enabledRotation", true);
    index._defineProperty(inherits._assertThisInitialized(_this), "clean", null);
