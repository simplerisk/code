...
render_header_and_sidebar(['blockUI', 'selectize', 'datatables', 'WYSIWYG', 'multiselect', 'easyui', 'CUSTOM:pages/compliance.js'], ['check_compliance' => true]);
        ...
        <div class="modal-dialog modal-md">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                   <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" aria-label="Close"><?php echo $escaper->escapeHtml($lang['Cancel']); ?></button>
                   <button type="button" id="update_framework" class="btn btn-danger"><?php echo $escaper->escapeHtml($lang['Update']); ?></button>
                </div>
            </div>
        </div>
    </div>
             ...
             <div class="modal-content">
                ...
                <div class="modal-footer">
                   <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" aria-label="Close">
                        <?php echo $escaper->escapeHtml($lang['Cancel']); ?>
                    </button>
                    <button type="button" id="update_control" class="btn btn-danger">
                        <?php echo $escaper->escapeHtml($lang['Update']); ?>
                    </button>
                </div>
            </div>
        </div>
...
<div id="test--edit" class="modal fade " tabindex="-1" aria-labelledby="risk-catalog--add" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
                ...
                <form class="" id="update-test-form" method="post" autocomplete="off">
                    ...
                    <div class="row">
                        ...
                        <div class="col-12 col-md-6">
                            ...
                            <span class="white-labels">(<?php echo $escaper->escapeHtml($lang['days']); ?>)</span>
                        </div>
                        <div class="col-12 col-md-6">
            ...
            <div class="modal-footer">
               <button type="button" name="cancel_add_tags" class="btn btn-secondary" data-bs-dismiss="modal" aria-label="Close"><?php echo $escaper->escapeHtml($lang['Cancel']); ?></button>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                        <div class="form-group">
                            ...
                            <label for=""><?php echo $escaper->escapeHtml($lang['Tags']); ?></label>
                            <select class="test_tags" readonly name="tags[]" multiple placeholder="<?php echo $escaper->escapeHtml($lang['TagsWidgetPlaceholder']);?>"></select>
                            <div class="tag-max-length-warning"><?php echo $escaper->escapeHtml($lang['MaxTagLengthWarning']);?></div>
                ...
                <div class="modal-footer">
                    <button type="button" name="cancel_add_tags" class="btn btn-secondary" data-bs-dismiss="modal" aria-label="Close"><?php echo $escaper->escapeHtml($lang['Cancel']); ?></button>
                    <button name="continue_add_tags" class="btn btn-danger" data-bs-dismiss="modal" aria-hidden="true"><?php echo $escaper->escapeHtml($lang['Continue']); ?></button>
                </div>
            </div>
        </div>
    </form>
