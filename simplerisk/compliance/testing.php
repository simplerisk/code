        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="form-group text-center">
                        <button id="" class="btn btn-primary associate_new_risk" aria-hidden="true"><?php echo $escaper->escapeHtml($lang['NewRisk']); ?></button>
                        <button id="" class="btn btn-primary associate_existing_risk" aria-hidden="true"><?php echo $escaper->escapeHtml($lang['ExistingRisk']); ?></button>
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <button id="add_existing_risks" type="button" class="btn btn-danger"><?php echo $escaper->escapeHtml($lang['Select']); ?></button>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <div class="form-group text-center">
                        <button id="remove-associate-risk-yes" class="btn btn-primary"><?php echo $escaper->escapeHtml($lang['Yes']); ?></button>
