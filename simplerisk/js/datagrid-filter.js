	...
	function resizeFilter(target, field){
		...
		ff.each(function(){
			...
			if (cellWidth != _getContentWidth(cc)){
				var left_padding = parseInt(cc.css("padding-left"));
				var right_padding = parseInt(cc.css("padding-right"));
				this.filter.resize(this, cellWidth - btn._outerWidth() - left_padding - right_padding);
			}
