 ...
 *                                                                      *
 * createFacetedPicker(config) itself now lives in                       *
 * js/simplerisk/sr-faceted-picker.js (extracted once Document Program's *
 * control picker, simplerisk/governance/documentation.php, needed the   *
 * same engine) -- loaded before this file in every page's               *
 * render_header_and_sidebar() CUSTOM: script array (see compliance/     *
 * index.php), so it's available here as a bare global. The only         *
 * control-specific things left in THIS file are the ids and             *
 * getControlPicker() immediately below.                                 *
 ***********************************************************************/
