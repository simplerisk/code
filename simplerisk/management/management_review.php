...
<div class="row bg-white">
    <div class="col-12">
        <div class="card-body my-2 border">
            <div class="row">
                <div class="col-10">
                    <p><strong><?php echo $escaper->escapeHtml($lang['ManagementReviewHelp']); ?>.</strong></p>
                </div>
                <div class="col-2 text-end">
                    <a  data-sr-role="dt-settings" data-sr-target="management-review" href="#" title="<?php echo $escaper->escapeHtml($lang['Settings']);?>" role="button" class="btn btn-dark float-end" data-bs-toggle="modal" data-bs-target="#setting_modal"><i class="fa fa-cog"></i></a>
                </div>
            </div>
            <div class="row">
                 <div class="col-12">
