...
<div class="row bg-white">
	<div class="col-12">
		<div id="risk-table-container" class="mt-2">
...
<div class="modal fade show" id="confirm-modal" tabindex="-1" aria-labelledby="exampleModalLabel"aria-modal="true" role="dialog">
		...
		<div class="modal-content">
			<div class="modal-body">
				...
				<div class="form-group text-center">
					...
					<button class="btn btn-submit btn-callback" data-dismiss="modal" aria-hidden="true" onclick="delete_saved_selection()">Yes</button>
				</div>
			</div>
		</div>
	</div>
