<?php
    ...
    * file, You can obtain one at http://mozilla.org/MPL/2.0/. */
    ...
    render_header_and_sidebar(['blockUI', 'selectize', 'datatables', 'WYSIWYG', 'multiselect', 'tabs:logic', 'CUSTOM:pages/asset.js'], ['check_assets' => true]);
...
?>
        <div class="row">
            ...
            <div class="tab-content">
                <div class="tab-pane col-12 mt-2" id="unverified_assets" tabindex="0">
                ...
                <div class="tab-pane active col-12 mt-2 mb-2" id="verified_assets" tabindex="0">
