    ...
    <div class="col-12">
        ...
        <div id="documents-tab-content" class="plan-projects tab-data mt-2">
            <div class="status-tabs" >
                ...
                <?php if($_SESSION['add_documentation']) { ?>
    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" form="add-document-form" class="btn btn-submit" id="add_document"><?php echo $escaper->escapeHtml($lang['Add']); ?></button>
            </div> 
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-scrollable modal-dialog-centered">
        <div class="modal-content">
                        ...
                        <div class="col-12 form-group">
                            <div class="file-uploader">
                                ...
                                <div class="input-group">
                                    ...
                                    <label class="align-self-center" size="2">Max <?php echo $escaper->escapeHtml(round(get_setting('max_upload_size')/1024/1024)); ?> Mb</label>
                                </div>
            ...
            <div class="modal-footer">
              ...
              <button type="button" class="btn btn-submit" id="update_document"><?php echo $escaper->escapeHtml($lang['Update']); ?></button>
            </div>
        </div>
    </div>
</div>
            ...
            <div class="modal-body">
                <form id="delete-document-form" action="" method="post">
                  ...
                  <div class="form-group text-center control-delete-actions">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal" aria-hidden="true"><?php echo $escaper->escapeHtml($lang['Cancel']); ?></button>
                    <button type="submit" name="delete_document" class="btn btn-submit"><?php echo $escaper->escapeHtml($lang['Yes']); ?></button>
                  </div>
                </form>
            </div>
        </div>
...
<!-- Give the same border color as the other form controls to datagrid filter inputs -->
<style>
