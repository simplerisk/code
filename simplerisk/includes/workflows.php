...
function get_workflow_trigger_catalog(): array
{
    return [
        ...
        // approve_document()/unapprove_document() (includes/governance.php) have
        // dispatched these two since the formal document approval workflow landed,
        // but they were never registered here -- and dispatch_workflow_event()
        // silently no-ops for an unregistered event name, so they could never fire
        // a workflow and the builder could never offer them as a trigger. Mirrors
        // exception.approved / exception.unapproved below. Both are enriched with
        // the full document field set by enrich_workflow_context(), which keys off
        // the document_id in the payload rather than the event name.
        'document.approved' => [
            'label'       => 'Document Approved',
            'category'    => 'Governance',
            'description' => 'Fires when a document is approved.',
            'variables'   => [
                'document_id'             => 'Document ID',
                'document_name'           => 'Document name',
                'document_type'           => 'Document type',
        ...
        'document.unapproved' => [
            'label'       => 'Document Unapproved',
            'category'    => 'Governance',
            'description' => 'Fires when a document approval is revoked.',
            'variables'   => [
                'document_id'             => 'Document ID',
                'document_name'           => 'Document name',
                'document_type'           => 'Document type',
            ...
            'inputs'                   => [
                'field' => [
                    ...
                    'options'  => [
                        ...
                        ['value' => 'document__document_type',          'label' => 'Document Type',          'trigger_types' => ['document.created', 'document.updated', 'document.approved', 'document.unapproved']],
                        ['value' => 'document__document_name',          'label' => 'Document Name',          'trigger_types' => ['document.created', 'document.updated', 'document.approved', 'document.unapproved']],
                        ['value' => 'document__document_frameworks',    'label' => 'Frameworks',             'trigger_types' => ['document.created', 'document.updated', 'document.approved', 'document.unapproved']],
                        ['value' => 'document__document_controls',      'label' => 'Controls',               'trigger_types' => ['document.created', 'document.updated', 'document.approved', 'document.unapproved']],
                        ['value' => 'document__additional_stakeholders','label' => 'Additional Stakeholders','trigger_types' => ['document.created', 'document.updated', 'document.approved', 'document.unapproved']],
                        ['value' => 'document__document_owner',         'label' => 'Document Owner',         'trigger_types' => ['document.created', 'document.updated', 'document.approved', 'document.unapproved']],
                        ['value' => 'document__team_ids',               'label' => 'Team',                   'trigger_types' => ['document.created', 'document.updated', 'document.approved', 'document.unapproved']],
                        ['value' => 'document__creation_date',          'label' => 'Creation Date',          'trigger_types' => ['document.created', 'document.updated', 'document.approved', 'document.unapproved']],
                        ['value' => 'document__last_review_date',       'label' => 'Last Review',            'trigger_types' => ['document.created', 'document.updated', 'document.approved', 'document.unapproved']],
                        ['value' => 'document__review_frequency',       'label' => 'Review Frequency',       'trigger_types' => ['document.created', 'document.updated', 'document.approved', 'document.unapproved']],
                        ['value' => 'document__next_review_date',       'label' => 'Next Review Date',       'trigger_types' => ['document.created', 'document.updated', 'document.approved', 'document.unapproved']],
                        ['value' => 'document__approval_date',          'label' => 'Approval Date',          'trigger_types' => ['document.created', 'document.updated', 'document.approved', 'document.unapproved']],
                        ['value' => 'document__approver',               'label' => 'Approver',               'trigger_types' => ['document.created', 'document.updated', 'document.approved', 'document.unapproved']],
                        ['value' => 'document__parent',                 'label' => 'Parent Document',        'trigger_types' => ['document.created', 'document.updated', 'document.approved', 'document.unapproved']],
                        ['value' => 'document__document_status',        'label' => 'Document Status',        'trigger_types' => ['document.created', 'document.updated', 'document.approved', 'document.unapproved']],
