...
render_header_and_sidebar(['blockUI', 'multiselect', 'bootstrap-table'], ['check_admin' => true], 'Secure Controls Framework (SCF) Extra', 'Configure', 'Extras');
        ...
        if (!complianceforge_scf_extra())
        {
            echo "
                <div class='card-body my-2 border'>
                    <button onclick='activateSecureControlsFramework();' class='btn btn-submit'>" . $escaper->escapeHtml($lang['Activate']) . "</button>
                </div>";
        }
