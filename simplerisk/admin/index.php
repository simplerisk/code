<?php
    ...
    * file, You can obtain one at http://mozilla.org/MPL/2.0/. */
    ...
    render_header_and_sidebar(
        ['blockUI', 'CUSTOM:settings-hub.js'],
        ...
        required_localization_keys: [
            ...
            'Cards', 'List',
            'Configure', 'Settings', 'Preferences', 'HealthCheck', 'About', 'RegisterAndUpgrade',
            'Active', 'Purchase',
            ...
            'InstallExtraTitle', 'InstallExtraBody', 'Install', 'InstallExtraError',
