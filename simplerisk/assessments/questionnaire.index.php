...
<html dir="ltr" lang="en" xml:lang="en">
  <head>
    ...
    <script src="../vendor/simplerisk/selectize.js/dist/js/standalone/selectize.min.js?<?= $current_app_version ?>" defer id="script_selectize"></script>
            	...
            	<div class="scroll-content">
            		<div class="content-wrapper">
                        ...
                        <div class="content container-fluid">
                        	<div class="container questionnaire-result-container">
