...
function view_reporting_menu($active)
{
    ...
    $result .=  ($active == "RiskDashboard" ? "<li class=\"active\">\n" : "<li>\n");
    $result .=  "<a href=\"index.php\">" . $escaper->escapeHtml($lang['RiskDashboard']) . "</a>\n";
    $result .=  "</li>\n";
    $result .=  ($active == "RiskTrend" ? "<li class=\"active\">\n" : "<li>\n");
    $result .=  "<a href=\"trend.php\">" . $escaper->escapeHtml($lang['RiskTrend']) . "</a>\n";
    $result .=  "</li>\n";
    $result .=  ($active == "AllOpenRisksAssignedToMeByRiskLevel" ? "<li class=\"active\">\n" : "<li>\n");
    $result .=  "<a href=\"my_open.php\">" . $escaper->escapeHtml($lang['AllOpenRisksAssignedToMeByRiskLevel']) . "</a>\n";
    $result .=  "</li>\n";
    ...
    $result .=  "</li>\n";
    $result .=  ($active == "AllOpenRisksToSubmitAsAProductionIssueByRiskLevel" ? "<li class=\"active\">\n" : "<li>\n");
    $result .=  "<a href=\"production_issues.php\">" . $escaper->escapeHtml($lang['AllOpenRisksToSubmitAsAProductionIssueByRiskLevel']) . "</a>\n";
    $result .=  "</li>\n";
    $result .=  ($active == "AllOpenRisksByTeam" ? "<li class=\"active\">\n" : "<li>\n");
    $result .=  "<a href=\"teams.php\">" . $escaper->escapeHtml($lang['AllOpenRisksByTeam']) . "</a>\n";
    $result .=  "</li>\n";
    $result .=  ($active == "AllOpenRisksByTechnology" ? "<li class=\"active\">\n" : "<li>\n");
    $result .=  "<a href=\"technologies.php\">" . $escaper->escapeHtml($lang['AllOpenRisksByTechnology']) . "</a>\n";
    $result .=  "</li>\n";
    $result .=  ($active == "AllOpenRisksByScoringMethod" ? "<li class=\"active\">\n" : "<li>\n");
    $result .=  "<a href=\"risk_scoring.php\">" . $escaper->escapeHtml($lang['AllOpenRisksByScoringMethod']) . "</a>\n";
    $result .=  "</li>\n";
    $result .=  ($active == "AllOpenRisksNeedingReview" ? "<li class=\"active\">\n" : "<li>\n");
    $result .=  "<a href=\"review_needed.php\">" . $escaper->escapeHtml($lang['AllOpenRisksNeedingReview']) . "</a>\n";
    $result .=  "</li>\n";
    $result .=  ($active == "AllClosedRisksByRiskLevel" ? "<li class=\"active\">\n" : "<li>\n");
    $result .=  "<a href=\"closed.php\">" . $escaper->escapeHtml($lang['AllClosedRisksByRiskLevel']) . "</a>\n";
    $result .=  "</li>\n";
    $result .=  ($active == "HighRiskReport" ? "<li class=\"active\">\n" : "<li>\n");
    $result .=  "<a href=\"high.php\">" . $escaper->escapeHtml($lang['HighRiskReport']) . "</a>\n";
    $result .=  "</li>\n";
    $result .=  ($active == "SubmittedRisksByDate" ? "<li class=\"active\">\n" : "<li>\n");
    $result .=  "<a href=\"submitted_by_date.php\">" . $escaper->escapeHtml($lang['SubmittedRisksByDate']) . "</a>\n";
    $result .=  "</li>\n";
    $result .=  ($active == "MitigationsByDate" ? "<li class=\"active\">\n" : "<li>\n");
    $result .=  "<a href=\"mitigations_by_date.php\">" . $escaper->escapeHtml($lang['MitigationsByDate']) . "</a>\n";
    $result .=  "</li>\n";
    $result .=  ($active == "ManagementReviewsByDate" ? "<li class=\"active\">\n" : "<li>\n");
    $result .=  "<a href=\"mgmt_reviews_by_date.php\">" . $escaper->escapeHtml($lang['ManagementReviewsByDate']) . "</a>\n";
    $result .=  "</li>\n";
