            ...
            <div class="navbar-content">
                <ul class="nav">
                    ...
                    if (isset($_SESSION["access"]) && $_SESSION["access"] == "granted") {
                        ...
                        echo "<li>\n";
                        echo "<a href=\"profile.php\">" . $escaper->escapeHtml($lang['MyProfile']) . "</a>\n";
                        echo "</li>\n";
                        echo "<li>\n";
        ...
        <div class="row-fluid">
            <div class="span9">
                <div class="row-fluid">
                    <div class="span12">
                        <div class="hero-unit">
                            <h4><?php echo $escaper->escapeHtml($lang['ProfileDetails']); ?></h4>
                            <?php echo $escaper->escapeHtml($lang['FullName']); ?>: <input style="cursor: default;"
                                                                                           name="name" type="text"
                                                                                           maxlength="50" size="20"
                                                                                           title="<?php echo $escaper->escapeHtml($name); ?>"
                                                                                           disabled="disabled"
                                                                                           value="<?php echo $escaper->escapeHtml($name); ?>"/><br/>
                            <?php echo $escaper->escapeHtml($lang['EmailAddress']); ?>: <input style="cursor: default;"
                                                                                               name="email" type="text"
                                                                                               maxlength="200" size="20"
                                                                                               title="<?php echo $escaper->escapeHtml($email); ?>"
                                                                                               disabled="disabled"
                                                                                               value="<?php echo $escaper->escapeHtml($email); ?>"/><br/>
                            <?php echo $escaper->escapeHtml($lang['Username']); ?>: <input style="cursor: default;"
                                                                                           name="username" type="text"
                                                                                           maxlength="20" size="20"
                                                                                           title="<?php echo $escaper->escapeHtml($username); ?>"
                                                                                           disabled="disabled"
                                                                                           value="<?php echo $escaper->escapeHtml($username); ?>"/><br/>
                            <?php echo $escaper->escapeHtml($lang['LastLogin']); ?>: <input style="cursor: default;"
                                                                                            name="last_login"
                                                                                            type="text" maxlength="20"
                                                                                            size="20"
                                                                                            title="<?php echo $escaper->escapeHtml($last_login); ?>"
                                                                                            disabled="disabled"
                                                                                            value="<?php echo $escaper->escapeHtml($last_login); ?>"/><br/>

                            <form name="change_language" method="post" action="">
                                <?php echo $lang['Language']; ?>
                                : <?php create_dropdown("languages", get_value_by_name("languages", $language)); ?>
                                <input type="submit" name="change_language" value="Update"/><br/>
                            </form>
                            ...
                            <ul>
                                <li><input name="submit_risks"
                                           type="checkbox"<?php if ($submit_risks) echo " checked" ?> />&nbsp;<?php echo $escaper->escapeHtml($lang['AbleToSubmitNewRisks']); ?>
                                </li>
                                <li><input name="modify_risks"
                                           type="checkbox"<?php if ($modify_risks) echo " checked" ?> />&nbsp;<?php echo $escaper->escapeHtml($lang['AbleToModifyExistingRisks']); ?>
                                </li>
                                <li><input name="close_risks"
                                           type="checkbox"<?php if ($close_risks) echo " checked" ?> />&nbsp;<?php echo $escaper->escapeHtml($lang['AbleToCloseRisks']); ?>
                                </li>
                                <li><input name="plan_mitigations"
                                           type="checkbox"<?php if ($plan_mitigations) echo " checked" ?> />&nbsp;<?php echo $escaper->escapeHtml($lang['AbleToPlanMitigations']); ?>
                                </li>
                                <li><input name="review_low" type="checkbox"<?php if ($review_low) echo " checked" ?> />&nbsp;<?php echo $escaper->escapeHtml($lang['AbleToReviewLowRisks']); ?>
                                </li>
                                <li><input name="review_medium"
                                           type="checkbox"<?php if ($review_medium) echo " checked" ?> />&nbsp;<?php echo $escaper->escapeHtml($lang['AbleToReviewMediumRisks']); ?>
                                </li>
                                <li><input name="review_high"
                                           type="checkbox"<?php if ($review_high) echo " checked" ?> />&nbsp;<?php echo $escaper->escapeHtml($lang['AbleToReviewHighRisks']); ?>
                                </li>
                                <li><input name="admin"
                                           type="checkbox"<?php if ($admin) echo " checked" ?> />&nbsp;<?php echo $escaper->escapeHtml($lang['AllowAccessToConfigureMenu']); ?>
                                </li>
                            </ul>
                        </div>
                        <?php
                        if (isset($_SESSION['user_type']) && $_SESSION['user_type'] != "ldap") {
                            ...
                            echo "<h4>" . $escaper->escapeHtml($lang['ChangePassword']) . "</h4><br />\n";
                            echo "<form name=\"change_password\" method=\"post\" action=\"\">\n";
                            echo $escaper->escapeHtml($lang['CurrentPassword']) . ": <input maxlength=\"100\" name=\"current_pass\" id=\"current_pass\" class=\"input-medium\" type=\"password\" autocomplete=\"off\" /><br />\n";
                            echo $escaper->escapeHtml($lang['NewPassword']) . ": <input maxlength=\"100\" name=\"new_pass\" id=\"new_pass\" class=\"input-medium\" type=\"password\" autocomplete=\"off\" /><br />\n";
                            echo $escaper->escapeHtml($lang['ConfirmPassword']) . ": <input maxlength=\"100\" name=\"confirm_pass\" id=\"confirm_pass\" class=\"input-medium\" type=\"password\" autocomplete=\"off\" /><br />\n";
