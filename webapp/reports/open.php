...
$localvars['html_reporting_menu'] = view_reporting_menu("AllOpenRisksByRiskLevel");

$localvars['ReportOpenHelp'] = $lang['ReportOpenHelp'];


$localvars['html_risk_table'] = get_risk_table(0);
