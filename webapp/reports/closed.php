...
$localvars['html_reporting_menu'] = view_reporting_menu("AllClosedRisksByRiskLevel");

$localvars['ReportClosedHelp'] = $lang['ReportClosedHelp'];


$localvars['html_risk_table'] = get_risk_table(4);

$template = $twig->loadTemplate('reports_open.html.twig');
