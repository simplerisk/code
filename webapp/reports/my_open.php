...
$localvars['html_reporting_menu'] = view_reporting_menu("AllOpenRisksAssignedToMeByRiskLevel");

$localvars['ReportMyOpenHelp'] = $lang['ReportMyOpenHelp'];


$localvars['html_risk_table'] = get_risk_table(8);

$template = $twig->loadTemplate('reports_my_open.html.twig');
