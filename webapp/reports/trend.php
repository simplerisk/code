...
$localvars['html_reporting_menu'] = view_reporting_menu("RiskTrend");

$localvars['html_RisksOpenedAndClosedOverTime'] = get_risk_trend($escaper->escapeHtml($lang['RisksOpenedAndClosedOverTime']));

$template = $twig->loadTemplate('reports_trend.html.twig');
