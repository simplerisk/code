 ...
 *
 *
 * @method     ChildReviewQuery orderByValue($order = Criteria::ASC) Order by the value column
 * @method     ChildReviewQuery orderByName($order = Criteria::ASC) Order by the name column
 *
 * @method     ChildReviewQuery groupByValue() Group by the value column
 * @method     ChildReviewQuery groupByName() Group by the name column
 *
 ...
 *
 * @method     ChildReview findOneByValue(int $value) Return the first ChildReview filtered by the value column
 * @method     ChildReview findOneByName(string $name) Return the first ChildReview filtered by the name column
 *
 ...
 * @method     ChildReview[]|ObjectCollection findByValue(int $value) Return ChildReview objects filtered by the value column
 * @method     ChildReview[]|ObjectCollection findByName(string $name) Return ChildReview objects filtered by the name column
...
abstract class ReviewQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'lessrisk', $modelName = '\\Review', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT value, name FROM review WHERE value = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(ReviewTableMap::COL_VALUE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(ReviewTableMap::COL_VALUE, $keys, Criteria::IN);
    }
    ...
    public function filterByValue($value = null, $comparison = null)
    {
        if (is_array($value)) {
            $useMinMax = false;
            if (isset($value['min'])) {
                $this->addUsingAlias(ReviewTableMap::COL_VALUE, $value['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($value['max'])) {
                $this->addUsingAlias(ReviewTableMap::COL_VALUE, $value['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ReviewTableMap::COL_VALUE, $value, $comparison);
    }
    ...
    public function filterByName($name = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(ReviewTableMap::COL_NAME, $name, $comparison);
    }
    ...
    {
        if ($review) {
            $this->addUsingAlias(ReviewTableMap::COL_VALUE, $review->getValue(), Criteria::NOT_EQUAL);
        }
