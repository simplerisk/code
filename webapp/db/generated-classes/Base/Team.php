...
abstract class Team implements ActiveRecordInterface
{
    ...
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[TeamTableMap::COL_VALUE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : TeamTableMap::translateFieldName('Value', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TeamTableMap::COL_VALUE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TeamTableMap::COL_VALUE)) {
            $criteria->add(TeamTableMap::COL_VALUE, $this->value);
        }
        if ($this->isColumnModified(TeamTableMap::COL_NAME)) {
