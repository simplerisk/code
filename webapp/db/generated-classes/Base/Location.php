...
abstract class Location implements ActiveRecordInterface
{
    ...
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[LocationTableMap::COL_VALUE] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : LocationTableMap::translateFieldName('Value', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(LocationTableMap::COL_VALUE)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LocationTableMap::COL_VALUE)) {
            $criteria->add(LocationTableMap::COL_VALUE, $this->value);
        }
        if ($this->isColumnModified(LocationTableMap::COL_NAME)) {
