 ...
 *
 *
 * @method     ChildLocationQuery orderByValue($order = Criteria::ASC) Order by the value column
 * @method     ChildLocationQuery orderByName($order = Criteria::ASC) Order by the name column
 *
 * @method     ChildLocationQuery groupByValue() Group by the value column
 ...
 *
 * @method     ChildLocation findOneByValue(int $value) Return the first ChildLocation filtered by the value column
 ...
 * @method     ChildLocation[]|ObjectCollection findByValue(int $value) Return ChildLocation objects filtered by the value column
...
abstract class LocationQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'lessrisk', $modelName = '\\Location', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT value, name FROM location WHERE value = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(LocationTableMap::COL_VALUE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(LocationTableMap::COL_VALUE, $keys, Criteria::IN);
    }
    ...
    public function filterByValue($value = null, $comparison = null)
    {
        if (is_array($value)) {
            $useMinMax = false;
            if (isset($value['min'])) {
                $this->addUsingAlias(LocationTableMap::COL_VALUE, $value['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($value['max'])) {
                $this->addUsingAlias(LocationTableMap::COL_VALUE, $value['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(LocationTableMap::COL_VALUE, $value, $comparison);
    }
    ...
    {
        if ($location) {
            $this->addUsingAlias(LocationTableMap::COL_VALUE, $location->getValue(), Criteria::NOT_EQUAL);
        }
