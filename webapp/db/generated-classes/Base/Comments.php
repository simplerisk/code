...
abstract class Comments implements ActiveRecordInterface
{
    ...
    public function setRiskId($v)
    {
        ...
        if ($this->risk_id !== $v) {
            $this->risk_id = $v;
            $this->modifiedColumns[CommentsTableMap::COL_RISK_ID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CommentsTableMap::translateFieldName('RiskId', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CommentsTableMap::translateFieldName('User', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(CommentsTableMap::COL_RISK_ID)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(CommentsTableMap::COL_RISK_ID)) {
            $criteria->add(CommentsTableMap::COL_RISK_ID, $this->risk_id);
        }
        if ($this->isColumnModified(CommentsTableMap::COL_DATE)) {
