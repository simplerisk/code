...
abstract class Languages implements ActiveRecordInterface
{
    ...
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[LanguagesTableMap::COL_VALUE] = true;
        }
    ...
    public function setFull($v)
    {
        ...
        if ($this->full !== $v) {
            $this->full = $v;
            $this->modifiedColumns[LanguagesTableMap::COL_FULL] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : LanguagesTableMap::translateFieldName('Value', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : LanguagesTableMap::translateFieldName('Full', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 3; // 3 = LanguagesTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(LanguagesTableMap::COL_VALUE)) {
            $modifiedColumns[':p' . $index++]  = 'value';
        }
        if ($this->isColumnModified(LanguagesTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(LanguagesTableMap::COL_FULL)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LanguagesTableMap::COL_VALUE)) {
            $criteria->add(LanguagesTableMap::COL_VALUE, $this->value);
        }
        if ($this->isColumnModified(LanguagesTableMap::COL_NAME)) {
            $criteria->add(LanguagesTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(LanguagesTableMap::COL_FULL)) {
            $criteria->add(LanguagesTableMap::COL_FULL, $this->full);
        }
