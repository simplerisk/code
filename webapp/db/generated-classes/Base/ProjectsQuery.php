 ...
 *
 *
 * @method     ChildProjectsQuery orderByValue($order = Criteria::ASC) Order by the value column
 * @method     ChildProjectsQuery orderByName($order = Criteria::ASC) Order by the name column
 * @method     ChildProjectsQuery orderByOrder($order = Criteria::ASC) Order by the order column
 * @method     ChildProjectsQuery orderByStatus($order = Criteria::ASC) Order by the status column
 *
 * @method     ChildProjectsQuery groupByValue() Group by the value column
 * @method     ChildProjectsQuery groupByName() Group by the name column
 * @method     ChildProjectsQuery groupByOrder() Group by the order column
 ...
 *
 * @method     ChildProjects findOneByValue(int $value) Return the first ChildProjects filtered by the value column
 * @method     ChildProjects findOneByName(string $name) Return the first ChildProjects filtered by the name column
 * @method     ChildProjects findOneByOrder(int $order) Return the first ChildProjects filtered by the order column
 * @method     ChildProjects findOneByStatus(int $status) Return the first ChildProjects filtered by the status column
 *
 ...
 * @method     ChildProjects[]|ObjectCollection findByValue(int $value) Return ChildProjects objects filtered by the value column
 * @method     ChildProjects[]|ObjectCollection findByName(string $name) Return ChildProjects objects filtered by the name column
 * @method     ChildProjects[]|ObjectCollection findByOrder(int $order) Return ChildProjects objects filtered by the order column
 * @method     ChildProjects[]|ObjectCollection findByStatus(int $status) Return ChildProjects objects filtered by the status column
...
abstract class ProjectsQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'lessrisk', $modelName = '\\Projects', $modelAlias = null)
    {
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = ProjectsTableMap::getInstanceFromPool((string) $key))) && !$this->formatter) {
    ...
    {
        $sql = 'SELECT value, name, order, status FROM projects WHERE value = :p0';
        try {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            ProjectsTableMap::addInstanceToPool($obj, (string) $key);
        }
        $stmt->closeCursor();
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(ProjectsTableMap::COL_VALUE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(ProjectsTableMap::COL_VALUE, $keys, Criteria::IN);
    }
    ...
    public function filterByValue($value = null, $comparison = null)
    {
        if (is_array($value)) {
            $useMinMax = false;
            if (isset($value['min'])) {
                $this->addUsingAlias(ProjectsTableMap::COL_VALUE, $value['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($value['max'])) {
                $this->addUsingAlias(ProjectsTableMap::COL_VALUE, $value['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ProjectsTableMap::COL_VALUE, $value, $comparison);
    }
    ...
    public function filterByOrder($order = null, $comparison = null)
    {
        if (is_array($order)) {
            $useMinMax = false;
            if (isset($order['min'])) {
                $this->addUsingAlias(ProjectsTableMap::COL_ORDER, $order['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($order['max'])) {
                $this->addUsingAlias(ProjectsTableMap::COL_ORDER, $order['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(ProjectsTableMap::COL_ORDER, $order, $comparison);
    }
    ...
    public function filterByStatus($status = null, $comparison = null)
    {
        if (is_array($status)) {
            $useMinMax = false;
            if (isset($status['min'])) {
                $this->addUsingAlias(ProjectsTableMap::COL_STATUS, $status['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($status['max'])) {
                $this->addUsingAlias(ProjectsTableMap::COL_STATUS, $status['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
    ...
    {
        if ($projects) {
            $this->addUsingAlias(ProjectsTableMap::COL_VALUE, $projects->getValue(), Criteria::NOT_EQUAL);
        }
