...
abstract class Projects implements ActiveRecordInterface
{
    ...
    public function setValue($v)
    {
        ...
        if ($this->value !== $v) {
            $this->value = $v;
            $this->modifiedColumns[ProjectsTableMap::COL_VALUE] = true;
        }
    ...
    public function setOrder($v)
    {
        ...
        if ($this->order !== $v) {
            $this->order = $v;
            $this->modifiedColumns[ProjectsTableMap::COL_ORDER] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ProjectsTableMap::translateFieldName('Value', TableMap::TYPE_PHPNAME, $indexType)];
            $this->value = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ProjectsTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ProjectsTableMap::translateFieldName('Order', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 4; // 4 = ProjectsTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ProjectsTableMap::COL_VALUE)) {
            $modifiedColumns[':p' . $index++]  = 'value';
        }
        if ($this->isColumnModified(ProjectsTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(ProjectsTableMap::COL_ORDER)) {
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProjectsTableMap::COL_VALUE)) {
            $criteria->add(ProjectsTableMap::COL_VALUE, $this->value);
        }
        if ($this->isColumnModified(ProjectsTableMap::COL_NAME)) {
            $criteria->add(ProjectsTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(ProjectsTableMap::COL_ORDER)) {
            $criteria->add(ProjectsTableMap::COL_ORDER, $this->order);
        }
        if ($this->isColumnModified(ProjectsTableMap::COL_STATUS)) {
