 ...
 *
 *
 * @method     ChildCategoryQuery orderByValue($order = Criteria::ASC) Order by the value column
 * @method     ChildCategoryQuery orderByName($order = Criteria::ASC) Order by the name column
 *
 * @method     ChildCategoryQuery groupByValue() Group by the value column
 ...
 *
 * @method     ChildCategory findOneByValue(int $value) Return the first ChildCategory filtered by the value column
 ...
 * @method     ChildCategory[]|ObjectCollection findByValue(int $value) Return ChildCategory objects filtered by the value column
...
abstract class CategoryQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'lessrisk', $modelName = '\\Category', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT value, name FROM category WHERE value = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(CategoryTableMap::COL_VALUE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(CategoryTableMap::COL_VALUE, $keys, Criteria::IN);
    }
    ...
    public function filterByValue($value = null, $comparison = null)
    {
        if (is_array($value)) {
            $useMinMax = false;
            if (isset($value['min'])) {
                $this->addUsingAlias(CategoryTableMap::COL_VALUE, $value['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($value['max'])) {
                $this->addUsingAlias(CategoryTableMap::COL_VALUE, $value['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(CategoryTableMap::COL_VALUE, $value, $comparison);
    }
    ...
    {
        if ($category) {
            $this->addUsingAlias(CategoryTableMap::COL_VALUE, $category->getValue(), Criteria::NOT_EQUAL);
        }
