 ...
 *
 *
 * @method     ChildTeamQuery orderByValue($order = Criteria::ASC) Order by the value column
 * @method     ChildTeamQuery orderByName($order = Criteria::ASC) Order by the name column
 *
 * @method     ChildTeamQuery groupByValue() Group by the value column
 ...
 *
 * @method     ChildTeam findOneByValue(int $value) Return the first ChildTeam filtered by the value column
 ...
 * @method     ChildTeam[]|ObjectCollection findByValue(int $value) Return ChildTeam objects filtered by the value column
...
abstract class TeamQuery extends ModelCriteria
{
     ...
     */
    public function __construct($dbName = 'lessrisk', $modelName = '\\Team', $modelAlias = null)
    {
    ...
    {
        $sql = 'SELECT value, name FROM team WHERE value = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(TeamTableMap::COL_VALUE, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(TeamTableMap::COL_VALUE, $keys, Criteria::IN);
    }
    ...
    public function filterByValue($value = null, $comparison = null)
    {
        if (is_array($value)) {
            $useMinMax = false;
            if (isset($value['min'])) {
                $this->addUsingAlias(TeamTableMap::COL_VALUE, $value['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($value['max'])) {
                $this->addUsingAlias(TeamTableMap::COL_VALUE, $value['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(TeamTableMap::COL_VALUE, $value, $comparison);
    }
    ...
    {
        if ($team) {
            $this->addUsingAlias(TeamTableMap::COL_VALUE, $team->getValue(), Criteria::NOT_EQUAL);
        }
