...
class TeamTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(TeamTableMap::COL_VALUE, TeamTableMap::COL_NAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(TeamTableMap::COL_VALUE => 0, TeamTableMap::COL_NAME => 1, ),
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(TeamTableMap::COL_VALUE);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(TeamTableMap::COL_VALUE, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(TeamTableMap::COL_VALUE) && $criteria->keyContainsValue(TeamTableMap::COL_VALUE) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.TeamTableMap::COL_VALUE.')');
        }
