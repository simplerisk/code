...
class LocationTableMap extends TableMap
{
     ...
     */
    const COL_VALUE = 'location.value';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(LocationTableMap::COL_VALUE, LocationTableMap::COL_NAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(LocationTableMap::COL_VALUE => 0, LocationTableMap::COL_NAME => 1, ),
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(LocationTableMap::COL_VALUE);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(LocationTableMap::COL_VALUE, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(LocationTableMap::COL_VALUE) && $criteria->keyContainsValue(LocationTableMap::COL_VALUE) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.LocationTableMap::COL_VALUE.')');
        }
