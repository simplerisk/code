...
class CategoryTableMap extends TableMap
{
     ...
     */
    const COL_VALUE = 'category.value';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(CategoryTableMap::COL_VALUE, CategoryTableMap::COL_NAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(CategoryTableMap::COL_VALUE => 0, CategoryTableMap::COL_NAME => 1, ),
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(CategoryTableMap::COL_VALUE);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(CategoryTableMap::COL_VALUE, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(CategoryTableMap::COL_VALUE) && $criteria->keyContainsValue(CategoryTableMap::COL_VALUE) ) {
