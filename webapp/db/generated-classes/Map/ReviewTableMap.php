...
class ReviewTableMap extends TableMap
{
     ...
     */
    const COL_VALUE = 'review.value';

    /**
     * the column name for the name field
     */
    const COL_NAME = 'review.name';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(ReviewTableMap::COL_VALUE, ReviewTableMap::COL_NAME, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(ReviewTableMap::COL_VALUE => 0, ReviewTableMap::COL_NAME => 1, ),
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ReviewTableMap::COL_VALUE);
            $criteria->addSelectColumn(ReviewTableMap::COL_NAME);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(ReviewTableMap::COL_VALUE, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(ReviewTableMap::COL_VALUE) && $criteria->keyContainsValue(ReviewTableMap::COL_VALUE) ) {
