...
class ProjectsTableMap extends TableMap
{
     ...
     */
    const COL_VALUE = 'projects.value';
     ...
     */
    const COL_ORDER = 'projects.order';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Value', 'Name', 'Order', 'Status', ),
        self::TYPE_CAMELNAME     => array('value', 'name', 'order', 'status', ),
        self::TYPE_COLNAME       => array(ProjectsTableMap::COL_VALUE, ProjectsTableMap::COL_NAME, ProjectsTableMap::COL_ORDER, ProjectsTableMap::COL_STATUS, ),
        self::TYPE_FIELDNAME     => array('value', 'name', 'order', 'status', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Value' => 0, 'Name' => 1, 'Order' => 2, 'Status' => 3, ),
        self::TYPE_CAMELNAME     => array('value' => 0, 'name' => 1, 'order' => 2, 'status' => 3, ),
        self::TYPE_COLNAME       => array(ProjectsTableMap::COL_VALUE => 0, ProjectsTableMap::COL_NAME => 1, ProjectsTableMap::COL_ORDER => 2, ProjectsTableMap::COL_STATUS => 3, ),
        self::TYPE_FIELDNAME     => array('value' => 0, 'name' => 1, 'order' => 2, 'status' => 3, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('order', 'Order', 'INTEGER', true, null, 999999);
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ProjectsTableMap::COL_VALUE);
            $criteria->addSelectColumn(ProjectsTableMap::COL_NAME);
            $criteria->addSelectColumn(ProjectsTableMap::COL_ORDER);
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            $criteria->add(ProjectsTableMap::COL_VALUE, (array) $values, Criteria::IN);
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria->containsKey(ProjectsTableMap::COL_VALUE) && $criteria->keyContainsValue(ProjectsTableMap::COL_VALUE) ) {
            throw new PropelException('Cannot insert a value for auto-increment primary key ('.ProjectsTableMap::COL_VALUE.')');
        }
