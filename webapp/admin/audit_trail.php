...
$localvars['html_adm_menu'] = view_configure_menu("AuditTrail");

$localvars['AuditTrail'] = $lang['AuditTrail'];

$localvars['html_audit_trail'] = get_audit_trail();

$template = $twig->loadTemplate('admin_audit_trail.html.twig');
