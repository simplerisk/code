...
$localvars['html_adm_menu'] = view_configure_menu("Announcements");

$localvars['html_announcements'] =  get_announcements();

$template = $twig->loadTemplate('admin_announcements.html.twig');
