<?php
	...
	if (isset($_POST['update_user']) && isset($_POST['user']))
	{
		...
		if (is_int($user_id))
		{
			...
			// Update the user
			update_user($user_id, $name, $email, $team, $admin, $review_high, $review_medium, $review_low, $submit_risks, $modify_risks, $plan_mitigations, $close_risks, $multi_factor);
    ...
    <div class="container-fluid">
      <div class="row-fluid">
		...
		Last Login: <input name="last_login" type="text" maxlength="20" size="20" disabled="disabled" value="<?php echo $last_login; ?>" /><br />
                ...
                <input type="radio" name="multi_factor" value="1"<?php if ($multi_factor == 1) echo " checked" ?> />&nbsp;None<br />
<?php
